...
class CreateViewSelectedCertificateAssets extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("
            ...
            SELECT
                ...
                c.id AS certificate_id,c.certificate_num, c.certificate_date, c.document_num, c.document_date, c.status, c.sub_status, c.status_updated_at, c.service_fee, c.created_at,
