...
class CreateVerhicleCertificateAssetLawsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('verhicle_certificate_asset_laws', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('verhicle_certificate_asset_laws');
    }
}
