...
class CreateCertificateApartmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('certificate_apartments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('certificate_apartments');
    }
}
