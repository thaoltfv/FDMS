...
class CreateVerhicleCertificateAssetLawInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('verhicle_certificate_asset_law_infos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('verhicle_certificate_asset_law_infos');
    }
}
