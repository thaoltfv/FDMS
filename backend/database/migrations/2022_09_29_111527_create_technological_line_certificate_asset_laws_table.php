...
class CreateTechnologicalLineCertificateAssetLawsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('technological_line_certificate_asset_laws', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('technological_line_certificate_asset_laws');
    }
}
