...
class CreateMachineCertificateBriefLawsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('machine_certificate_brief_laws', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('machine_certificate_brief_laws');
    }
}
