...
class CreateVerhicleCertificateBriefLawInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('verhicle_certificate_brief_law_infos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('verhicle_certificate_brief_law_infos');
    }
}
