...
class CreateOtherCertificateAssetLawInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('other_certificate_asset_law_infos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('other_certificate_asset_law_infos');
    }
}
