...
class CreateCertificateTangibleComparisonFactorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::Create('certificate_tangible_comparison_factor', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('certificate_tangible_comparison_factor');
    }
}
