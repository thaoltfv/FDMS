...
class CreateMachineCertificateAssetLawInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('machine_certificate_asset_law_infos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('machine_certificate_asset_law_infos');
    }
}
