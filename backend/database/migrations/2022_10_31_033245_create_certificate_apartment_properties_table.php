...
class CreateCertificateApartmentPropertiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('certificate_apartment_properties', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('certificate_apartment_properties');
    }
}
