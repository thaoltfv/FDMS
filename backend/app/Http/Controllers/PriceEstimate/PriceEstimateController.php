...
class PriceEstimateController extends Controller
{
    ...
    public function getPriceEstimateDataFullForPreCertificate(Request $request)
    {
        ...
        $result = $this->priceEstimateRepository->getPriceEstimateDataFullForPreCertificate($request);
    ...
    public function postGeneralInfomation(Request $request, int $id = null)
    {
        ...
        $rules = [
            ...
            'general_infomation.appraise_asset' => 'required|string',
            'general_infomation.coordinates' => 'required|string',
            'traffic_infomation' => 'array|required',
            'traffic_infomation.description' => 'required|string',
    ...
    public function step3Final(Request $request, int $id)
    {
        ...
        $rules = [
            ...
            'appraise_asset' => 'required|string',
            'coordinates' => 'required|string',
            'description' => 'nullable|string',
            'petitioner_name' => 'nullable|string',
            'full_address' => 'required|string',
            'img_map' => 'nullable|string',
