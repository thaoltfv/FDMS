...
class TechnologicalLineCertificateAssetController extends Controller
{
    private TechnologyCertificateAssetRepository $technologyAsset;

    public function __construct(TechnologyCertificateAssetRepository $technologyAsset)
    {
        $this->technologyAsset = $technologyAsset;
    }
    public function postStep1(Request $request, int $id = null)
    {
        ...
        if ($validator->passes()) {
            ...
            $result = $this->technologyAsset->postStep1($request->toArray(), $id);
    ...
    {
        try{
            $result = $this->technologyAsset->getStep1($id);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    public function postStep2(Request $request, int $id)
    {
        ...
        if ($validator->passes()) {
            //TODO Handle your data
            $result = $this->technologyAsset->postStep2($request->toArray(), $id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        } else {
    ...
    {
        try{
            $result = $this->technologyAsset->getStep2($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    public function postStep3(Request $request, int $id)
    {
        ...
        if ($validator->passes()) {
            //TODO Handle your data
            $result = $this->technologyAsset->postStep3($request->toArray(), $id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        } else {
    ...
    {
        try{
            $result = $this->technologyAsset->getStep3($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    public function postStep4(Request $request, int $id)
    {
        ...
        if ($validator->passes()) {
            //TODO Handle your data
            $result = $this->technologyAsset->postStep4($request->toArray(), $id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        } else {
    ...
    {
        try{
            $result = $this->technologyAsset->getStep4($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    {
        try{
            $result = $this->technologyAsset->getAll($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
