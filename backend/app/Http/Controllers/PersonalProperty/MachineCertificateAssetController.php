...
class MachineCertificateAssetController extends Controller
{
    private MachineCertificateAssetRepository $machineAsset;

    public function __construct(MachineCertificateAssetRepository $machineAsset)
    {
        $this->machineAsset = $machineAsset;
    }
    public function postStep1(Request $request, int $id = null)
    {
        ...
        if ($validator->passes()) {
            ...
            $result = $this->machineAsset->postStep1($request->toArray(), $id);
    ...
    {
        try{
            $result = $this->machineAsset->getStep1($id);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    public function postStep2(Request $request, int $id)
    {
        ...
        if ($validator->passes()) {
            //TODO Handle your data
            $result = $this->machineAsset->postStep2($request->toArray(), $id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        } else {
    ...
    {
        try{
            $result = $this->machineAsset->getStep2($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    public function postStep3(Request $request, int $id)
    {
        ...
        if ($validator->passes()) {
            //TODO Handle your data
            $result = $this->machineAsset->postStep3($request->toArray(), $id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        } else {
    ...
    {
        try{
            $result = $this->machineAsset->getStep3($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    public function postStep4(Request $request, int $id)
    {
        ...
        if ($validator->passes()) {
            //TODO Handle your data
            $result = $this->machineAsset->postStep4($request->toArray(), $id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        } else {
    ...
    {
        try{
            $result = $this->machineAsset->getStep4($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    {
        try{
            $result = $this->machineAsset->getAll($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
