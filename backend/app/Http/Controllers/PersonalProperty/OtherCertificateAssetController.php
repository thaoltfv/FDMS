...
class OtherCertificateAssetController extends Controller
{
    private OtherCertificateAssetRepository $otherAsset;

    public function __construct(OtherCertificateAssetRepository $otherAsset)
    {
    ...
    public function postStep1(Request $request, int $id = null)
    {
        ...
        if ($validator->passes()) {
            ...
            $result = $this->otherAsset->postStep1($request->toArray(), $id);
    ...
    {
        try{
            $result = $this->otherAsset->getStep1($id);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    public function postStep2(Request $request, int $id)
    {
        ...
        if ($validator->passes()) {
            //TODO Handle your data
            $result = $this->otherAsset->postStep2($request->toArray(), $id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        } else {
    ...
    {
        try{
            $result = $this->otherAsset->getStep2($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    public function postStep3(Request $request, int $id)
    {
        ...
        if ($validator->passes()) {
            //TODO Handle your data
            $result = $this->otherAsset->postStep3($request->toArray(), $id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        } else {
    ...
    {
        try{
            $result = $this->otherAsset->getStep3($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    public function postStep4(Request $request, int $id)
    {
        ...
        if ($validator->passes()) {
            //TODO Handle your data
            $result = $this->otherAsset->postStep4($request->toArray(), $id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        } else {
    ...
    {
        try{
            $result = $this->otherAsset->getStep4($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
    ...
    {
        try{
            $result = $this->otherAsset->getAll($id);
            if(isset($result['message']) && isset($result['exception']))
                return $this->respondWithErrorData( $result);
            return $this->respondWithCustomData($result);
        }catch(Exception $ex){
