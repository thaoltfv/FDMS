...
class MachineCertificateBrief extends Model
{
    use SoftDeletes;
    protected $casts = [
        'id' => 'integer',
    ...
    {
        return $this->belongsTo(Dictionary::class,'model','id');
    }
    ...
    {
        return $this->hasMany(MachineCertificateBriefLaw::class,'machine_asset_id','id');
    }
    ...
    {
        return $this->hasOne(MachineCertificateBriefPrice::class, 'machine_asset_id', 'id');
    }

    public function otherInfomation():HasOne
    {
        return $this->hasOne(MachineCertificateBriefLawInfo::class, 'machine_asset_id', 'id');
    }
