...
class OtherCertificateAsset extends Model
{
    use SoftDeletes;
    // protected $hidden = [
    //     'laravel_through_key'
    ...
    {
        return $this->hasMany(OtherCertificateAssetLaw::class,'other_asset_id','id');
    }
    ...
    {
        return $this->hasOne(OtherCertificateAssetPrice::class, 'other_asset_id', 'id');
    }

    public function otherInfomation():HasOne
    {
        return $this->hasOne(OtherCertificateAssetLawInfo::class, 'other_asset_id', 'id');
    }
