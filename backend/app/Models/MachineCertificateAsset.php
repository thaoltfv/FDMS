...
class MachineCertificateAsset extends Model
{
    use SoftDeletes;
    protected $casts = [
        'id' => 'integer',
    ...
    {
        return $this->hasMany(MachineCertificateAssetLaw::class,'machine_asset_id','id');
    }
    ...
    {
        return $this->hasOne(MachineCertificateAssetPrice::class, 'machine_asset_id', 'id');
    }

    public function otherInfomation():HasOne
    {
        return $this->hasOne(MachineCertificateAssetLawInfo::class, 'machine_asset_id', 'id');
    }
