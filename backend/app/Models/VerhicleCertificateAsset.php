...
class VerhicleCertificateAsset extends Model
{
    use SoftDeletes;
    protected $casts = [
        'id' => 'integer',
    ...
    {
        return $this->hasMany(VerhicleCertificateAssetLaw::class,'verhicle_asset_id','id');
    }
    ...
    {
        return $this->hasOne(VerhicleCertificateAssetPrice::class, 'verhicle_asset_id', 'id');
    }

    public function otherInfomation():HasOne
    {
        return $this->hasOne(VerhicleCertificateAssetLawInfo::class, 'verhicle_asset_id', 'id');
    }
