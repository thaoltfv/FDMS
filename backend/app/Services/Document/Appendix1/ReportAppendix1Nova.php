...
class ReportAppendix1Nova extends ReportAppendix1
{
    ...
    protected function conclusion1($section)
    {
        ...
        $textRun = $section->addTextRun();
        $textRun->addText('     - Tổ thẩm định giá nhận thấy chất lượng thông tin về các tài sản so sánh là tương đương nhau, kết hợp phân tích các tiêu chí tổng giá trị điều chỉnh gộp, tổng số lần điều chỉnh, biên độ điều chỉnh, tổng giá trị điều chỉnh thuần, tổ thẩm định giá sử dụng mức giá chỉ dẫn của tài sản so sánh … làm mức giá tham chiếu của tài sản thẩm định giá.');
    }
