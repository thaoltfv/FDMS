...
class CreateOtherCertificateBriefLawsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('other_certificate_brief_laws', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('other_certificate_brief_laws');
    }
}
