...
export default class CertificateBrief extends Model {
	...
	static async getStepAvailable(id = "") {
		return new this().request({
			method: "GET",
			url: `certification_asset/step/${id}`,
			isStatic: true
		});
	}
	static async getDetailCertificate(id = "") {
		return new this().request({
			method: "GET",
			url: `certification_brief/certificate-general-infomation/${id}`,
			isStatic: true
		});
	}
	static async updateDetailCertificate(id = "", data) {
		return new this().request({
			method: "POST",
			url: `certification_brief/certificate-update-general/${id}`,
			data,
			isStatic: true
		});
	}
	static async getDetailCertificateBrief(id = "") {
		return new this().request({
			method: "GET",
			url: `certification_brief/certificate-infomation/${id}`,
			isStatic: true
		});
	}
	...
	static async submitStep1CertificationBrief(data, id = "") {
		return new this().request({
			method: "POST",
			url: `certification_brief/step1-infomation-certification/${id}`,
			data: data,
			isStatic: true
		});
	}
	static async updateStatusCertificate(id = "", data) {
		return new this().request({
			method: "POST",
			url: `certification_brief/certificate-update-status/${id}`,
			data: data,
			isStatic: true
		});
	}
	static async getListAppraise(id = "") {
		return new this().request({
			method: "GET",
			url: `certification_brief/certificate-appraise-list?certificate_id=${id}`,
			isStatic: true
		});
	}
	static async updateAppraiseCertificate(id = "", data) {
		return new this().request({
			method: "POST",
			url: `certification_brief/certificate-update-appraise/${id}`,
			data: data,
			isStatic: true
		});
	}
	static async getListKanbanCertificate(search = "", status) {
		...
		return new this().request({
			method: "GET",
			url: `workflow/certificate-workflow`,
			query: searchInput,
			isStatic: true
		});
	}
	...
	static async updateAppraisers(id = "", data) {
		return new this().request({
			method: "POST",
			url: `certification_brief/certificate-update-appraisers/${id}`,
			data: data,
			isStatic: true
		});
	}
	static async getAppraiseCompare(ids) {
		...
		return new this().request({
			method: "GET",
			url: `certification_brief/comparison-appraise?ids=${data}`,
			isStatic: true
		});
	}
	static async exportDataCertificationBrief(data) {
		...
		return new this().request({
			method: "GET",
			url: `certification_brief/brief-export?fromDate=${fromDate}&toDate=${toDate}&status=${status}&created_by=${createdBy}&appraiser_id=${appraiser_id}&appraiser_perform_id=${appraiser_perform_id}&customer_id=${customer_id}`,
			isStatic: true
		});
	}
	...
	static async exportDataCertificationBriefCustomize(data) {
		...
		return new this().request({
			method: "GET",
			url: `certification_brief/brief-customize-export?fromDate=${fromDate}&toDate=${toDate}&status=${status}&created_by=${createdBy}&appraiser_id=${appraiser_id}&appraiser_perform_id=${appraiser_perform_id}&customer_id=${customer_id}`,
			isStatic: true
		});
	}
	static async getHistoryTimeline(id) {
		return new this().request({
			method: "GET",
			url: `activity/get-certificate/${id}`,
			isStatic: true
		});
	}
	static async updateAppraiseCertificateVersion(id = "", data) {
		return new this().request({
			method: "POST",
			url: `certification_brief/certificate-update-appraise-version/${id}`,
			data: data,
			isStatic: true
		});
	}
	static async getAssetVersion(ids) {
		...
		return new this().request({
			method: "GET",
			url: `certification_brief/asset-version?ids=${data}`,
			isStatic: true
		});
	}
	static async getCertificateStatus(id) {
		return new this().request({
			method: "GET",
			url: `certification_brief/get-status/${id}`,
			isStatic: true
		});
	}
	...
	static async updateSubStatusFromConfig(data) {
		return new this().request({
			method: "PUT",
			url: `config/update-certificate-sub-status`,
			data: data,
			isStatic: true
		});
	}
