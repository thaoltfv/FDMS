						...
						<div class="row">
							...
							<div class="position-relative col-12 col-lg-4">
								...
								<div class="img-locate">
									<img
										src="@/assets/icons/ic_locate.svg"
										alt=""
										@click.prevent="handleMap()"
									/>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-12">
									<a-table
										...
										:rowClassName="
											(record, index) =>
												index === indexBlock ? 'table-row-selected' : ''
										"
									...
									>
										...
										<template
											slot="apartments_per_floor"
											slot-scope="apartments_per_floor"
										>
										...
										<template slot="action" slot-scope="action, record, index">
											<div class="d-flex justify-content-center">
												<button
													class="btn-delete"
													type="button"
													@click="handleEditBlock(action, record, index)"
												>
				...
				<div
					v-if="
						(indexBlock || indexBlock === 0) &&
							this.selectedRowKeysBlock &&
							this.selectedRowKeysBlock.length > 0
					"
					class="card"
				>
					<div class="card-title">
							...
							<div class="row">
								<div class="col-12">
									<a-table
										...
										:rowClassName="
											(record, index) =>
												index === indexFloor ? 'table-row-selected' : ''
										"
										...
										<template slot="action" slot-scope="action, record, index">
											<div class="d-flex justify-content-center">
												<button
													class="btn-delete"
													type="button"
													@click="handleEditFloor(action, record, index)"
												>
													<img alt="add" src="@/assets/icons/ic_edit_2.svg" />
												</button>
												<!-- <div>
...
export default {
	...
	methods: {
		handleActionApartment(data) {
			if (this.isEdit) {
				this.form.block[this.indexBlock].floor[this.indexFloor].apartment[
					this.indexEdit
				] = data;
			} else {
				this.form.block[this.indexBlock].floor[this.indexFloor].apartment.push(
					data
				);
			}
		...
		onSelectChangeFloor(item, selectedRows) {
			...
			this.apartments = this.form.block[this.indexBlock].floor[
				item[0]
			].apartment;
		},
		handleModalAddFloor() {
