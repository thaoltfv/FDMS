      ...
      <div class="card">
        <div class="container-title">
          <div class="d-flex justify-content-between">
            <h2 class="title">{{isEdit ? 'Chỉnh sửa thông tin tầng' : 'Thêm mới thông tin tầng'}}</h2>
        ...
        <div class="card-body">
          ...
          <div class="btn__group">
            ...
            <button class="btn btn-white btn-orange text-nowrap" type="button" @click.prevent="validateFloor"><img src="@/assets/icons/ic_save.svg" style="margin-right: 5px" alt="save"> Lưu</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
	...
	methods: {
		...
		async validateFloor () {
			const valid = await this.$refs.formFloor.validate()
			if (valid) {
