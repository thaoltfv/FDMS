 ...
 <div class="container-fluid">
   <div class="pannel">
     <div class="pannel__content d-xl-flex d-block justify-content-between align-items-end">
       ...
       <router-link :to="{name: 'ward.create'}" class="btn btn-create btn-white text-nowrap index-screen-button mt-xl-0 mt-2 px-3 m-0 mb-0" tag="button" v-if="add"><img
...
export default {
	...
	methods: {
		...
		async listWard (params = {}) {
			...
			try {
				const resp = await Ward.paginate({
					query: {
						page: 1,
						limit: 20,
						...params,
