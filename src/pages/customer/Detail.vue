				...
				<div class="card-body card-info">
					...
					<div class="d-grid">
						<div class="content-detail content-code">
							...
							<p class="content-name content-name__code">
								{{ "DT_" + form.id }}
							</p>
						</div>
						...
						<div class="content-detail">
							...
							<p class="content-name" v-if="form.phone !== null">
								{{ form.phone }}
							</p>
						</div>
						...
						<div class="content-detail">
						 ...
						 <div class="d-grid">
							<div class="content-detail content-code">
								...
								<p class="content-name">
									{{
										form.customer_group ? form.customer_group.description : ""
									}}
								</p>
							</div>
						</div> 
