...
export default {
	...
	async mounted () {
		await this.getDataCertificationBacklog()
	},
	methods: {
		async getDataCertificationBacklog () {
			const res = await Report.getReportCertificationBacklog(this.form)
