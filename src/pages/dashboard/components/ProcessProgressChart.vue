			...
			if (res.data && res.data.status && res.data.status.length > 0) {
				...
				res.data.status.forEach(item => {
					if (item === 1) {
						...
						this.chartDoughnut.datasets[0].backgroundColor.push("#45AAF0");
						...
						this.chartDoughnut.datasets[0].backgroundColor.push("#fab000");
						...
						this.chartDoughnut.datasets[0].backgroundColor.push("#fab015");
