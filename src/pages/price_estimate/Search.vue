<template>
  <div class="row justify-content-between">
    ...
    <div class="col-12 col-lg-1" >
      <button class="btn btn-orange w-100 text-nowrap float-right" id="coordinateSearch">
...
export default {
	...
	async mounted () {
		...
		if (this.address.province_id !== '' && this.address.province_id !== undefined && this.address.province_id !== null) {
			await this.changeProvinceCoordinate()
		}
		if (this.address.district_id !== '' && this.address.district_id !== undefined && this.address.district_id !== null) {
			await this.changeDistrictCoordinate()
		}
		if (this.address.street_id !== '' && this.address.street_id !== undefined && this.address.street_id !== null) {
	...
	methods: {
		initMap () {
			...
			document.getElementById('coordinateSearch').addEventListener('click', async () => {
