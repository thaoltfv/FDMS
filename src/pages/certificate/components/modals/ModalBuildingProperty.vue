					...
					<div class="contain-detail">
						<div class="property-detail">
							<div class="row justify-content-between">
								...
								<div
									class="col-12 col-lg-6 input-contain"
								...
								<div
									class="col-12 col-lg-6 input-contain"
									v-if="
										building === 'NHÀ Ở RIÊNG LẺ' || building === 'BIỆT THỰ'
									"
								>
									<InputCategory
								...
								>
									...
									<span
										class="text-error"
										v-if="form.floor !== '' && form.floor <= 0"
										>Vui lòng nhập số tầng thích hợp</span
									>
								</div>
								<div
									class="col-12 col-lg-6 input-contain"
								...
								<div class="col-12 col-lg-6 input-contain">
									...
									<span
										class="text-error"
										v-if="
											form.total_construction_area !== '' &&
												form.total_construction_area !== undefined &&
												form.total_construction_area !== null &&
												form.total_construction_area <= 0
										"
										>Vui lòng nhập diện tích xây dựng thích hợp</span
									>
								</div>
								<div class="col-12 col-lg-6 input-contain">
									<InputNumberFormat
									...
									<span
										class="text-error"
										v-if="
											form.total_construction_base !== '' &&
												form.total_construction_base !== undefined &&
												form.total_construction_base !== null &&
												form.total_construction_base <= 0
										"
										>Vui lòng nhập diện tích sàn thích hợp</span
									>
								</div>
								<div class="col-12 col-lg-6 input-contain">
									<InputNumberFormat
									...
									<span
										...
										v-if="
											form.duration !== '' &&
												...
												form.duration <= 0
										"
										>Vui lòng nhập niên hạn thích hợp</span
									>
								</div>
								<div class="col-12 col-lg-6 input-contain">
									<InputNumberFormat
...
export default {
	...
	methods: {
		...
		changeUsingYear(event) {
			if (event) {
				if (this.form.created_at) {
					if (
						+moment(this.form.created_at).format("YYYY") -
							this.form.start_using_year >
						this.form.duration
					) {
						this.form.remaining_quality = 0;
					} else
						this.form.remaining_quality = parseFloat(
							(1 -
								(+moment(this.form.created_at).format("YYYY") -
									this.form.start_using_year) /
									this.form.duration) *
					...
					if (
						new Date().getFullYear() - this.form.start_using_year >
						this.form.duration
					) {
						this.form.remaining_quality = 0;
					} else
		...
		remainingQuality(event) {
			...
			this.form.estimation_value =
				this.form.total_construction_base *
				this.form.unit_price_m2 *
				(this.form.remaining_quality / 100);
		},
		...
		async handleAction(event) {
			...
			try {
				...
				if (
					...
					!this.form.contruction_description ||
					this.form.total_construction_base <= 0 ||
		...
		async getBuildingPrices() {
			...
			if (
				(this.form.building_category_id !== "" &&
					this.form.building_category_id !== undefined &&
					this.form.building_category_id !== null &&
					this.form.rate_id !== "" &&
					this.form.rate_id !== undefined &&
					this.form.rate_id !== null) ||
				(this.form.structure_id !== "" &&
					this.form.structure_id !== undefined &&
					this.form.structure_id !== null &&
					this.form.rate_id !== "" &&
					this.form.rate_id !== undefined &&
					this.form.rate_id !== null) ||
				(this.form.crane_id !== "" &&
					this.form.crane_id !== undefined &&
					this.form.crane_id !== null &&
					this.form.aperture_id !== "" &&
					this.form.aperture_id !== undefined &&
					this.form.aperture_id !== null &&
					this.form.factory_type_id !== "" &&
					this.form.factory_type_id !== undefined &&
					this.form.factory_type_id !== null)
			) {
