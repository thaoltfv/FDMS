      ...
      <div
        ...
        <div class="card">
          ...
          <div class="contain-detail">
                ...
                <div class="contain-table">
                  <table class="table-property">
                    ...
                    <tr>
                      ...
                      <th>Diện tích thẩm định</th>
                      <th v-if="showZone">Diện tích quy hoạch</th>
                      <th v-if="showZone">Loại quy hoạch</th>
                      <th>Vị trí đất</th>
                      <th>Đơn giá đất theo QĐ của UBND</th>
                      <!-- <th>Hệ số K</th> -->
                      <th v-if="property.land_type.description === 'HỖN HỢP'">Cơ sở chuyển MDSD</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr v-for="(propertyDetail) in property.property_detail" :key="propertyDetail.id">
                      <td>
                        <div v-if="propertyDetail.land_type_purpose">
                        {{propertyDetail.land_type_purpose.description}}
                        </div>
                      </td>
                      <td>
                      ...
                      <td v-if="showZone">
                        {{propertyDetail.planning_area}}m<sup>2</sup>
                      </td>

                      <td v-if="showZone">
                        {{propertyDetail.type_zoning}}
                      </td>
                      ...
                      <td v-if="property.land_type.description === 'HỖN HỢP'">
                        <InputSwitchMDSD
                          v-model="propertyDetail.is_transfer_facility"
                          vid="is_transfer_facility"
                          label="Cơ sở chuyển mục đích"
                          :disabled="true"
            ...
            <div class="d-grid">
              <div class="content-detail">
                <p class="content-title">Tổng diện tích thẩm định:</p>
                <p class="content-name">{{property.appraise_land_sum_area}}m<sup>2</sup></p>
              </div>
            </div>
                ...
                <div class="contain-table">
                  <table class="table-property">
                    ...
                    <tr>
                      ...
                      <th>Khoảng cách đến đường chính</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr v-for="(alley) in property.property_turning_time" :key="alley.id">
                      <td>
                        {{alley.turning}}
                      </td>
                      <td>
                      ...
                      <td>
                        {{format(alley.main_road_distance)}} m
                      </td>
                    </tr>
                    </tbody>
                  </table>
	...
	methods: {
		getZoning () {
			if (typeof this.property !== 'undefined') {
				this.property.property_detail.forEach(element => {
					if (element.is_zoning) {
						this.showZone = true
					}
				})
			}
