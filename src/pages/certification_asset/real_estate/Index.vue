...
export default {
	...
	methods: {
		...
		async getDataDraft (params = {}) {
			...
			const filter = {}
			try {
				const resp = await AppraisePagingData.paginate({ query: { page: 1, limit: 20, ...params, ...filter, status: 1 } })
		...
		async getDataOpen (params = {}) {
			...
			const filter = {}
			try {
				const resp = await AppraisePagingData.paginate({ query: { page: 1, limit: 20, ...params, ...filter, status: 2 } })
		...
		async getDataLock (params = {}) {
			...
			const filter = {}
			try {
				const resp = await AppraisePagingData.paginate({ query: { page: 1, limit: 20, ...params, ...filter, status: 3 } })
		...
		async getDataClose (params = {}) {
			...
			const filter = {}
			try {
				const resp = await AppraisePagingData.paginate({ query: { page: 1, limit: 20, ...params, ...filter, status: 4 } })
		...
		async getDataAll (params = {}) {
			this.isLoading = true
			try {
				const resp = await AppraisePagingData.paginate({ query: { page: 1, limit: 20, ...params, ...this.filter, status: this.selectedStatus } })
