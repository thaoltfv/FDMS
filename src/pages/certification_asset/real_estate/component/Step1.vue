        ...
        <Tabs class="tab_contruction" :theme="theme" :navAuto="true">
          <TabItem name="Đường tiếp giáp tài sản">
            <div class="mt-2">
              ...
              <div class="container-img row mr-0 ml-0">
                <div class="contain-img contain-img__property" v-if="imageType && data.picture_infomation.length > 0 && imageType.id && images.type_id === imageType.id" v-for="(images, index) in data.picture_infomation" :key="images.id">
          ...
          <TabItem name="Tổng thể tài sản">
            <div class="mt-2">
              ...
              <div class="container-img row mr-0 ml-0">
                <div class="contain-img contain-img__property" v-if="imgOverall && data.picture_infomation.length > 0 && imgOverall.id && images.type_id === imgOverall.id" v-for="(images, index) in data.picture_infomation" :key="images.id">
                  <div class="delete" @click="removeImage(index)">X</div>
                  <img class="asset-img" :src="images.link" alt="img" @click="openModalImage(images)">
                </div>
								<div class="container_input_img">
          ...
          <TabItem name="Hiện trạng tài sản">
            <div class="mt-2">
              ...
              <div class="container-img row mr-0 ml-0">
                <div class="contain-img contain-img__property" v-if="imageCurrentStatus && data.picture_infomation.length > 0 && imageCurrentStatus.id && images.type_id === imageCurrentStatus.id" v-for="(images, index) in data.picture_infomation" :key="images.id">
                  <div class="delete" @click="removeImage(index)">X</div>
                  <img class="asset-img" :src="images.link" alt="img" @click="openModalImage(images)">
                </div>
								<div class="container_input_img">
          ...
          <TabItem name="Khác">
            <div class="mt-2">
              ...
              <div class="container-img row mr-0 ml-0">
                <div class="contain-img contain-img__property" v-if="imageJuridical && data.picture_infomation.length > 0 && imageJuridical.id && images.type_id === imageJuridical.id" v-for="(images, index) in data.picture_infomation" :key="images.id">
                  <div class="delete" @click="removeImage(index)">X</div>
                  <img class="asset-img" :src="images.link" alt="img" @click="openModalImage(images)">
                </div>
								<div class="container_input_img">
...
export default {
	name: 'Step1',
	props: ['data', 'propertyTypes', 'topographic', 'provinces', 'districts', 'wards', 'streets', 'distances', 'isEdit',
	...
	methods: {
		...
		changeAssetType (id) {
			if (id === 39) {
				this.data.general_infomation.asset_type_id = ''
				this.$toast.open({
			...
			} else this.$emit('getAssetType', id)
		},
		...
		async getTheLastTurningTime () {
			if (this.addressName.street) {
				...
				let streetName = ''
				let main_road_distance = this.data.traffic_infomation.property_turning_time[last_item].main_road_distance ? this.data.traffic_infomation.property_turning_time[last_item].main_road_distance : 0
				let description = ''
				...
				description = 'Tiếp giáp ' + (this.material ? this.material.toLowerCase() : '') + ' rộng khoảng ' + this.formatFloat(main_road_length) + 'm ' + 'cách tuyến ' + `${streetName}` + ' khoảng ' + this.formatFloat(main_road_distance) + 'm'
