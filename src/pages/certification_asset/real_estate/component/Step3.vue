        ...
        <div v-if="isHaveContruction" class="container-fluid">
                      ...
                      <tr v-for="(item, indexContruction) in data.construction" :key="indexContruction">
                        ...
                        <td>
                          <div class="d-flex justify-content-center">
                            ...
                            <div>
                              <button class="btn-delete" type="button" @click="handleDeleteContruction(indexContruction)"><img
          ...
          <div class="d-flex">
            <div class="w-100 d-flex justify-content-end">
              <button class="btn text-warning btn-ghost btn-add" type="button" @click="handleAddContruction">
