		...
		<div class="card">
			<div class="card-title">
				<div class="d-flex justify-content-between align-items-center">
					...
					<img
						class="img-dropdown"
						:class="!showDetailListContruction ? 'img-dropdown__hide' : ''"
						alt="dropdown"
			...
			<div class="card-body card-info" v-show="showDetailListContruction">
							...
							<div class="main-wrapper">
								<div class="responsive-table">
									<table class="table_contruction color_content">
										...
										<tbody>
											<tr
												v-for="(item, indexContruction) in data.construction"
												:key="indexContruction"
											>
												<td>
													<p class="mb-0">
														{{ item.id ? `CT_${item.id}` : "" }}
												...
												<td>
													<p class="name_contruct mb-0">
														{{ item.tangible_name ? item.tangible_name : "" }}
													</p>
												</td>
												<td>
													{{ formatNumber(item.total_construction_base) }}
												</td>
												...
												<td>
													<div class="d-flex justify-content-center">
														<button
															class="btn-delete"
															type="button"
															@click="handleEditContruction(indexContruction)"
														>
															<img
																alt="add"
														...
														<div>
															<button
																...
																type="button"
																@click="
																	handleDeleteContruction(indexContruction)
																"
															>
																<img
																	alt="delete_land"
				...
				<div v-else class="col-12">
					<div class="infor-box">
						...
						Tài sản thẩm định là đất trống không cần khai báo thông tin công
						trình xây dựng
					</div>
				</div>
			</div>
		</div>
		<ModalStep3Contruction
...
import ModalStep3Contruction from "./modals/ModalStep3Contruction";
