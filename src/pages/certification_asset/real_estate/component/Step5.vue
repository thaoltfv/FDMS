        ...
        <div class="container-fluid">
          <div class="row container_content pb-2">
            ...
            <div class="row col-lg-8">
              <div class="col-12 col-lg-6 pl-4 align-items-center" v-for="(itemFacility, indexFacility) in appraisalFacility" :key="indexFacility">
                <div class="d-flex form-group-container">
                  <input type="radio" :name="itemFacility.type" :id="itemFacility.id" :value="itemFacility.id" v-model="data.value_base_and_approach.appraise_basis_property_id">
                  <div style="margin-left: 0.5rem" class=""><label style="margin-bottom: unset !important" :for="itemFacility.id">{{itemFacility.name}}</label></div>
                </div>
              </div>
            </div>
          </div>
          <div class="row container_content pb-2">
            ...
            <div class="row col-lg-8">
              <div class="col-12 col-lg-6 pl-4 align-items-center" v-for="(itemPrinciple, indexPrinciple) in appraisalPrinciples" :key="indexPrinciple">
                <div class="d-flex form-group-container">
                  <input type="radio" :name="itemPrinciple.type" :id="itemPrinciple.id" :value="itemPrinciple.id" v-model="data.value_base_and_approach.appraise_principle_id">
                  <div style="margin-left: 0.5rem" class=""><label style="margin-bottom: unset !important" :for="itemPrinciple.id">{{itemPrinciple.name}}</label></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row container_content pb-2">
            ...
            <div class="row col-lg-8">
              <div class="col-12 col-lg-6 pl-4 align-items-center" v-for="(itemApproach, indexApproach) in approach" :key="indexApproach">
                <div class="d-flex form-group-container">
                  <input type="radio" :name="itemApproach.type" :id="itemApproach.id" :value="itemApproach.id" v-model="data.value_base_and_approach.appraise_approach_id">
                  <div style="margin-left: 0.5rem" class=""><label style="margin-bottom: unset !important" :for="itemApproach.id">{{itemApproach.name}}</label></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row container_content pb-2">
            ...
            <div class="row col-lg-8">
              <div class="col-12 col-lg-6 pl-4 align-items-center" v-for="(itemUsedMethod, indexUsedMethod) in methodsUsed" :key="indexUsedMethod">
                <div class="d-flex form-group-container">
                  <input type="radio" :name="itemUsedMethod.type" :id="itemUsedMethod.id" :value="itemUsedMethod.id" v-model="data.value_base_and_approach.appraise_method_used_id">
                  <div style="margin-left: 0.5rem" class=""><label style="margin-bottom: unset !important" :for="itemUsedMethod.id">{{itemUsedMethod.name}}</label></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row container_content pb-2 ">
            <div class="d-flex col-12 col-lg-4 color_content form-label font-weight-bold align-items-center form-group-container">Giả thiết và giả thiết đặc biệt</div>
              ...
              <div class="col-12 col-lg-8" >
                <div class="row align-items-center">
                  <div class="col-12 col-lg-4 pl-4 align-items-center" v-for="(itemIndicative, indexIndicative) in unifyIndicativePrice" :key="indexIndicative">
                    <div class="d-flex">
                      <input type="radio" :name="itemIndicative.slug" :id="itemIndicative.slug" :value="itemIndicative.slug" v-model="data.appraisal_methods.thong_nhat_muc_gia_chi_dan.slug_value">
                      <div style="margin-left: 0.5rem" class=""><label style="margin-bottom: unset !important" :for="itemIndicative.slug">{{itemIndicative.name}}</label></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 col-lg-8">
                <div class="row align-items-center pl-4" v-for="(itemLandRemaning, indexLandRemaning) in compositeLandRemaning" :key="indexLandRemaning">
                  <div class="col-7 col-lg-6 pl-0">
                    <div class="d-flex form-group-container" >
                      <input type="radio" :name="itemLandRemaning.slug" @change="handleChangeLandRemaining" :id="itemLandRemaning.slug" :value="itemLandRemaning.slug" v-model="data.appraisal_methods.tinh_gia_dat_hon_hop_con_lai.slug_value">
                      <div style="margin-left: 0.5rem" class=""><label style="margin-bottom: unset !important" :for="itemLandRemaning.slug">{{itemLandRemaning.name}}</label></div>
                    </div>
                  </div>
                  <div class="col-2" v-if="itemLandRemaning.slug === 'theo-ty-le-gia-dat-co-so-chinh'">
                    <InputPercent
                      ...
                      :max="100"
                      :decimal="0"
                      :disabled="data.appraisal_methods.tinh_gia_dat_hon_hop_con_lai.slug_value === 'theo-ty-le-gia-dat-co-so-chinh' ? false : true"
                      rules="required"
            ...
            <div class="row container_content pb-2" >
              ...
              <div class="col-12 col-lg-8" >
                <div class="row align-items-center pl-4" v-for="(itemVialationPrice, indexVialationPrice) in planningViolationPrice" :key="indexVialationPrice">
                  <div class="col-7 col-lg-6 pl-0">
                    <div class="d-flex form-group-container" >
                      <input type="radio" :name="itemVialationPrice.slug" :id="itemVialationPrice.slug" @change="handleChangeViolationPrice" :value="itemVialationPrice.slug" v-model="data.appraisal_methods.tinh_gia_dat_vi_pham_quy_hoach.slug_value">
                      <div style="margin-left: 0.5rem" class=""><label style="margin-bottom: unset !important" :for="itemVialationPrice.slug">{{itemVialationPrice.name}}</label></div>
                    </div>
                  </div>
                  <div class="col-2" v-if="itemVialationPrice.slug === 'theo-ty-le-gia-dat-thi-truong'">
                    <InputPercent
                      ...
                      :max="100"
                      :decimal="0"
                      :disabled="data.appraisal_methods.tinh_gia_dat_vi_pham_quy_hoach.slug_value === 'theo-ty-le-gia-dat-thi-truong' ? false : true"
                      rules="required"
                      class="form-group-container"
