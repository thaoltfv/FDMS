        ...
        <div class="container-fluid">
          <div class="row">
                  ...
                  <div class="main-map">
                    <div id="mapid" class="layer-map">
                      ...
                      >
                        ...
                        <l-control position="bottomleft">
                          <button class="btn btn-orange mini_btn" :class="{ 'btn_loading disabled': isRefesh }" type="button" id="btnRefesh" @click="handleRefeshMap">
                      ...
                      <div v-if="showDetailAsset" class="card_detail_asset">
                        ...
                        <div style="margin:unset; background-color:#F6F7FB" class="row content_detail_asset">
                          ...
                          <div class="d-flex justify-content-between w-100 mt-1">
                            ...
                            <div class="content_detail color_content">
                              {{ formatNumberArea(assetDetails.properties[0].asset_general_land_sum_area) }}
                              m<sup>2</sup>
                            </div>
                          </div>
                          <div class="d-flex justify-content-between w-100 mt-1">
                        ...
                        <div class="content_tab_detail">
                          <Tabs class="tab_details" :theme="theme" :navAuto="true">
                            <TabItem name="Mô tả chung">
                              <div class="row content_detail_asset">
                                <div class="d-flex justify-content-between w-100 mt-2">
                                  <div class="name_title color_content">Vị trí:</div>
                                  <div class="content_detail color_content">
                                    {{ assetDetails.properties[0].front_side === 1 ? 'Mặt tiền' : 'Hẻm' }}
                                  </div>
                                </div>
                                <div class="d-flex justify-content-between w-100 mt-1">
                                  <div class="name_title color_content">Bề rộng đường:</div>
                                  <div class="content_detail color_content">
                                ...
                                <div class="d-flex justify-content-between w-100 mt-1">
                                  <div class="name_title color_content">Loại tài sản:</div>
                                  <div class="content_detail color_content">
                                    {{ assetDetails.asset_type && assetDetails.asset_type.description }}
                                  </div>
                                </div>
                              </div>
                            </TabItem>
                            <TabItem class="item_2" name="Thông tin đất">
                              <div class="row content_detail_asset">
                                <div class="d-flex justify-content-between w-100 mt-2">
                                  <div class="name_title color_content">Loại đất:</div>
                                  <div class="content_detail color_content">
                                ...
                                <div class="d-flex justify-content-between w-100 mt-1">
                                  <div class="name_title color_content">Kích thước:</div>
                                  <div class="content_detail color_content">
                                    {{ `${assetDetails.properties[0].front_side_width} m x ${assetDetails.properties[0].insight_width} m` }}
                                  </div>
                                </div>
                                <div class="d-flex justify-content-between w-100 mt-1">
                                  <div class="name_title color_content">Hình dáng:</div>
                                  <div class="content_detail color_content">
                                    {{ assetDetails.properties[0].land_shape.description }}
                                  </div>
                                </div>
                              </div>
                            </TabItem>
                            <TabItem class="item_3" name="Giá trị BĐS">
                              <div class="row content_detail_asset">
                                ...
                                <div class="d-flex justify-content-between w-100 mt-1">
                                  ...
                                  <div class="content_detail color_content">
                                    {{ formatNumberArea(assetDetails.properties[0].property_detail[0].price_land) }}
                                    đ
                                  </div>
                                </div>
                              </div>
            ...
            <div class="d-flex justify-content-between w-100">
              <div class="d-flex">
                <button @click="openSelectType"
                             class="btn btn-white text-nowrap index-screen-button btn_create_asset"><img
...
export default {
    ...
    changeFilterYear(payload) {
		...
		handleChangeRouter () {
			const routeData = this.$router.resolve({ name: 'warehouse.create', query: { asset_type_id: this.asset_type_id } })
