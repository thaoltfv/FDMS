					...
					<TabItem name="Đường tiếp giáp tài sản">
						<div class="mt-2">
							...
							<div
								v-if="
									imageType &&
										data.pic.filter(i => i.type_id === imageType.id).length > 0
								"
								class="container-img row mr-0 ml-0"
							>
								<div
									class="contain-img contain-img__property"
									v-for="images in data.pic.filter(
					...
					<TabItem name="Tổng thể tài sản">
						<div class="mt-2">
							...
							<div
								v-if="
									imgOverall &&
										data.pic.filter(i => i.type_id === imgOverall.id).length > 0
								"
								class="container-img row mr-0 ml-0"
							>
								<div
					...
					<TabItem name="Khác">
						<div class="mt-2">
							...
							<div
								v-if="
									imageJuridical &&
										data.pic.filter(i => i.type_id === imageJuridical.id)
											.length > 0
								"
								class="container-img row mr-0 ml-0"
							>
				...
				<div class="container-fluid">
					<div class="row justify-content-flex-start container-utilities">
						<div
							...
							class="col-6 text-center form-group-container d-flex"
							v-for="(basic_utility, index) in basic_utilities"
							:key="index"
						>
							<div
