						...
						<TabItem name="Bảng tổng hợp thông tin">
							<div class="content_detail_asset">
								<ValidationObserver tag="form" ref="step_7_tab1">
									<div
										class="ant-table ant-table-scroll-position-left ant-table-default"
									>
										<div class="ant-table-content">
											<div class="ant-table-body">
												<table
													...
													v-if="
														apartment.assets_general &&
															apartment.assets_general.length > 0
													"
												>
													<thead class="ant-table-thead">
														<tr>
															...
															<th
																v-for="(asset,
																index) in apartment.assets_general"
																:key="'header' + index"
															>
																<a
													...
													<tbody class="ant-table-tbody">
															...
															<td>
																{{
																	data.apartment_asset_properties
																		? formatSentenceCase(
																				data.apartment_asset_properties.legal
																					.description
																		  )
																		: "-"
																}}
														...
														<tr>
															...
															<td>
																{{
																	data.apartment_asset_properties &&
																	data.apartment_asset_properties.rank
																		? formatSentenceCase(
																				data.apartment_asset_properties.rank
																					.description
																		  )
															...
															>
																{{
																	...
																	asset.apartment_specification.rank
																		? formatSentenceCase(
																				asset.apartment_specification.rank
																					.description
																		  )
														...
														<tr>
															...
															<td>
																{{
																	data.apartment_asset_properties
																		? formatSentenceCase(
																				data.apartment_asset_properties.block
																					.name
																		  )
																		: "-"
																}}
															...
															>
																{{
																	asset.block
																		? formatSentenceCase(asset.block.name)
																		: "-"
																}}
															</td>
														</tr>
														<tr>
															...
															>
																{{
																	asset.floor
																		? formatSentenceCase(asset.floor.name)
																		: "-"
																}}
															</td>
														</tr>
														...
														<tr>
															...
															>
																{{
																	asset.room_details &&
																	asset.room_details.length > 0 &&
																	asset.room_details[0].loaicanho
																		? formatSentenceCase(
																				asset.room_details[0].loaicanho
																					.description
																		  )
														...
														<tr>
															...
															<td>
																{{
																	data.apartment_asset_properties
																		? data.apartment_asset_properties.wc_num
																		: "-"
																}}
															</td>
															<td
														...
														<tr>
															...
															>
																{{
																	asset.room_details &&
																	asset.room_details.length > 0 &&
																	asset.room_details[0].furniture_quality
																		? formatSentenceCase(
																				asset.room_details[0].furniture_quality
																					.description
																		  )
														...
														<tr>
																	...
																	v-if="
																		data.apartment_asset_properties &&
																			data.apartment_asset_properties
																				.utility_description &&
																			data.apartment_asset_properties
																				.utility_description.length > 0
																	"
																>
																	<div
																		v-for="(utility, indexData) in data
															...
															>
																...
																>
																	<div
																		v-for="(utility, indexData) in asset
														...
														<tr>
															...
															>
																{{
																	asset.room_details &&
																	asset.room_details.length > 0 &&
																	asset.room_details[0].direction
																		? formatSentenceCase(
																				asset.room_details[0].direction
																					.description
																		  )
														...
														<tr>
															...
															<td></td>
															<td
																v-for="(asset, index) in form.apartment_adapter"
														...
														<tr>
															...
															<td>
																{{
																	formatNumber(parseFloat(dgcc1).toFixed(0))
																}}đ
															</td>
															<td>
																{{
																	formatNumber(parseFloat(dgcc2).toFixed(0))
																}}đ
															</td>
															<td>
																{{
																	formatNumber(parseFloat(dgcc3).toFixed(0))
																}}đ
															</td>
														</tr>
													</tbody>
									...
									<div class="ant-table-content">
										<div class="ant-table-body">
											<table
												...
												v-if="
													apartment.comparison_factor &&
														apartment.comparison_factor.length > 0
												"
											>
												<thead class="ant-table-thead">
													<tr>
														...
														<th
															v-for="(asset,
															index) in apartment.comparison_factor"
												...
												<tbody class="ant-table-tbody">
													<tr>
														...
														<td>Chưa biết</td>
														<td>
															{{ formatNumber(parseFloat(dgcc1).toFixed(0)) }}đ
														</td>
														<td>
															{{ formatNumber(parseFloat(dgcc2).toFixed(0)) }}đ
														</td>
														<td>
															{{ formatNumber(parseFloat(dgcc3).toFixed(0)) }}đ
														</td>
													</tr>
													<tr
														v-for="(comparison_factor_appraise,
														index) in apartment.comparison_factor[0].comparison_factor.filter(
													...
													>
														...
														>
															{{
																formatSentenceCase(
																	comparison_factor_appraise.apartment_title
																)
															}}
														</td>
														<td
															v-for="(asset, index) in apartment.assets_general"
															:key="'assetInfo' + index"
														>
															<span
																v-for="(comparison_factor,
																indexItem) in apartment.comparison_factor[index]
																	.comparison_factor"
																:key="'phap_ly' + indexItem"
															>
																<span
																	v-if="comparison_factor.type === 'phap_ly'"
																>
																	{{
																		formatSentenceCase(
																			comparison_factor.asset_title
																		)
																	}}
																</span>
															</span>
													...
													>
														...
														<td
															v-for="(asset,
															indexAsset) in apartment.assets_general"
															:key="'inputLegal' + indexAsset"
														>
															<div
																v-for="(comparison_factor, index) in apartment
																	.comparison_factor[indexAsset]
																	.comparison_factor"
																:key="'phap_lyC' + index"
															>
																<div
																...
																>
																	<InputPercent
																		...
																		class="label-none input_center"
																		v-model="
																			comparison_factor.adjust_coefficient
																		"
																		vid="number_legal"
																		:text_center="true"
																		@change="
													...
													>
														...
														<td>
															<strong>{{
																formatNumber(
																	parseFloat(totalPricePL1).toFixed(0)
																)
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(
																	parseFloat(totalPricePL2).toFixed(0)
																)
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(
																	parseFloat(totalPricePL3).toFixed(0)
																)
															}}</strong>
														</td>
													</tr>
													...
													>
														<td rowspan="5">
															<div
																...
																type="button"
																@click="
																	dialogDeleteComparisionDefault('loai_can')
																"
															>
																<img
														...
														<td
															v-for="(asset, index) in apartment.assets_general"
															:key="'assetLoaiCan' + index"
														>
															<span
																v-for="(comparison_factor,
																indexItem) in apartment.comparison_factor[index]
																	.comparison_factor"
																:key="'loaichungcu2' + indexItem"
															>
																<span
																	v-if="comparison_factor.type === 'loai_can'"
																>
																	{{
																		formatSentenceCase(
																			comparison_factor.asset_title
													...
													>
														...
														<td
															v-for="(asset,
															indexAsset) in apartment.assets_general"
															:key="'inputLoaiCan' + indexAsset"
														>
															<div
																v-for="(comparison_factor, index) in apartment
																	.comparison_factor[indexAsset]
																	.comparison_factor"
																:key="'loaichungcu4C' + index"
															>
																<div
																	v-if="comparison_factor.type === 'loai_can'"
																>
													...
													<tr
														...
														:key="'loaichungcu5' + index"
													>
														<td>Mức điều chỉnh</td>
														<td></td>
														<td>
															{{
																formatNumber(parseFloat(priceLch1).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceLch2).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceLch3).toFixed(0))
															}}
														</td>
													</tr>
													<tr
														...
														:key="'loaichungcu6' + index"
													>
														<td><strong>Giá sau điều chỉnh</strong></td>
														<td></td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["loai_can"][0])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["loai_can"][1])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["loai_can"][2])
															}}</strong>
														</td>
													</tr>
													...
													>
														<td rowspan="5">
															<div
																...
																type="button"
																@click="
																	dialogDeleteComparisionDefault('loai_can_ho')
																"
															>
																<img
																	src="@/assets/icons/ic_delete_2.svg"
														...
														<td
															v-for="(asset, index) in apartment.assets_general"
															:key="'assetLoaiCanHo' + index"
														>
															<span
																v-for="(comparison_factor,
																indexItem) in apartment.comparison_factor[index]
																	.comparison_factor"
																:key="'loaicanho2' + indexItem"
															>
																<span
																	v-if="
																		comparison_factor.type === 'loai_can_ho'
																	"
																>
																	{{
																		formatSentenceCase(
													...
													>
														...
														<td
															v-for="(asset,
															indexAsset) in apartment.assets_general"
															:key="'inputLoaiCanHo' + indexAsset"
														>
															<div
																v-for="(comparison_factor, index) in apartment
																	.comparison_factor[indexAsset]
																	.comparison_factor"
																:key="'loaicanho4C' + index"
															>
																<div
																	v-if="
																		comparison_factor.type === 'loai_can_ho'
													...
													<tr
														...
														:key="'loaicanho5' + index"
													>
														<td>Mức điều chỉnh</td>
														<td></td>
														<td>
															{{
																formatNumber(parseFloat(priceLcho1).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceLcho2).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceLcho3).toFixed(0))
															}}
														</td>
													</tr>
													<tr
														...
														:key="'loaicanho6' + index"
													>
														<td><strong>Giá sau điều chỉnh</strong></td>
														<td></td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["loai_can_ho"][0])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["loai_can_ho"][1])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["loai_can_ho"][2])
															}}</strong>
														</td>
													</tr>
													...
													>
														<td rowspan="5">
															<div
																...
																type="button"
																@click="
																	dialogDeleteComparisionDefault('dien_tich')
																"
															>
																<img
																	src="@/assets/icons/ic_delete_2.svg"
														...
														<td
															v-for="(asset, index) in apartment.assets_general"
															:key="'assetDienTich' + index"
														>
															<span
																v-for="(comparison_factor,
																indexItem) in apartment.comparison_factor[index]
																	.comparison_factor"
																:key="'dientich2' + indexItem"
															>
																<span
																	v-if="comparison_factor.type === 'dien_tich'"
																>
																	{{
																		parseFloat(comparison_factor.asset_title)
																			? formatNumber(
																					parseFloat(
																						comparison_factor.asset_title
																					)
													...
													>
														...
														<td
															v-for="(asset,
															indexAsset) in apartment.assets_general"
															:key="'inputDienTich' + indexAsset"
														>
															<div
																v-for="(comparison_factor, index) in apartment
																	.comparison_factor[indexAsset]
																	.comparison_factor"
																:key="'dientich4C' + index"
															>
																<div
																	v-if="comparison_factor.type === 'dien_tich'"
																>
													...
													>
														...
														<td>
															{{
																formatNumber(parseFloat(priceDt1).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceDt2).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceDt3).toFixed(0))
															}}
														</td>
													</tr>
													<tr
													...
													>
														...
														<td>
															<strong>{{
																formatNumber(adjustPriceData["dien_tich"][0])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["dien_tich"][1])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["dien_tich"][2])
															}}</strong>
														</td>
													</tr>
													...
													<tr
														...
														index) in apartment.comparison_factor[0].comparison_factor.filter(
															comparison_factor_appraise =>
																comparison_factor_appraise.type === 'tang' &&
																comparison_factor_appraise.status === 1
														)"
														:key="'tang' + index"
													>
														<td rowspan="5">
															<div
																...
																v-if="isEditStatus"
																type="button"
																@click="dialogDeleteComparisionDefault('tang')"
															>
																<img
																	src="@/assets/icons/ic_delete_2.svg"
																	alt="save"
													...
													>
														...
														<td>
															{{
																formatNumber(parseFloat(priceSt1).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceSt2).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceSt3).toFixed(0))
															}}
														</td>
													</tr>
													<tr
													...
													>
														...
														<td>
															<strong>{{
																formatNumber(adjustPriceData["tang"][0])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["tang"][1])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["tang"][2])
															}}</strong>
														</td>
													</tr>
													...
													>
														<td rowspan="5">
															<div
																...
																type="button"
																@click="
																	dialogDeleteComparisionDefault('so_phong_wc')
																"
															>
																<img
																	src="@/assets/icons/ic_delete_2.svg"
														...
														<td
															v-for="(asset, index) in apartment.assets_general"
															:key="'assetSoPhongWC' + index"
														>
															<span
																v-for="(comparison_factor,
																indexItem) in apartment.comparison_factor[index]
																	.comparison_factor"
																:key="'sophongwc2' + indexItem"
															>
																<span
																	v-if="
																		comparison_factor.type === 'so_phong_wc'
																	"
																>
																	{{
																		formatSentenceCase(
													...
													>
														...
														<td
															v-for="(asset,
															indexAsset) in apartment.assets_general"
															:key="'inputSoPhongWC' + indexAsset"
														>
															<div
																v-for="(comparison_factor, index) in apartment
																	.comparison_factor[indexAsset]
																	.comparison_factor"
																:key="'sophongwc4C' + index"
															>
																<div
																	v-if="
																		comparison_factor.type === 'so_phong_wc'
													...
													<tr
														...
														:key="'sophongwc5' + index"
													>
														<td>Mức điều chỉnh</td>
														<td></td>
														<td>
															{{
																formatNumber(parseFloat(pricePWC1).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(pricePWC2).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(pricePWC3).toFixed(0))
															}}
														</td>
													</tr>
													<tr
														...
														:key="'sophongwc6' + index"
													>
														<td><strong>Giá sau điều chỉnh</strong></td>
														<td></td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["so_phong_wc"][0])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["so_phong_wc"][1])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["so_phong_wc"][2])
															}}</strong>
														</td>
													</tr>
													...
													>
														<td rowspan="5">
															<div
																...
																type="button"
																@click="
																	dialogDeleteComparisionDefault('so_phong_ngu')
																"
															>
																<img
																	src="@/assets/icons/ic_delete_2.svg"
														...
														<td
															v-for="(asset, index) in apartment.assets_general"
															:key="'assetSoPhongNgu' + index"
														>
															<span
																v-for="(comparison_factor,
																indexItem) in apartment.comparison_factor[index]
																	.comparison_factor"
																:key="'sophongngu2' + indexItem"
															>
																<span
																	v-if="
																		comparison_factor.type === 'so_phong_ngu'
																	"
																>
																	{{
																		formatSentenceCase(
													...
													>
														...
														<td
															v-for="(asset,
															indexAsset) in apartment.assets_general"
															:key="'inputSoPhongNgu' + indexAsset"
														>
															<div
																v-for="(comparison_factor, index) in apartment
																	.comparison_factor[indexAsset]
																	.comparison_factor"
																:key="'sophongngu4C' + index"
															>
																<div
																	v-if="
																		comparison_factor.type === 'so_phong_ngu'
													...
													<tr
														...
														:key="'sophongngu5' + index"
													>
														<td>Mức điều chỉnh</td>
														<td></td>
														<td>
															{{
																formatNumber(parseFloat(pricePn1).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(pricePn2).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(pricePn3).toFixed(0))
															}}
														</td>
													</tr>
													<tr
														...
														:key="'sophongngu6' + index"
													>
														<td><strong>Giá sau điều chỉnh</strong></td>
														<td></td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["so_phong_ngu"][0])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["so_phong_ngu"][1])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["so_phong_ngu"][2])
															}}</strong>
														</td>
													</tr>
													...
													>
														<td rowspan="5">
															<div
																...
																type="button"
																@click="
																	dialogDeleteComparisionDefault('huong_chinh')
																"
															>
																<img
																	src="@/assets/icons/ic_delete_2.svg"
														...
														<td><strong>Hướng chính</strong></td>
														<td
															v-for="(comparison_factor_appraise,
															index) in apartment.comparison_factor[0].comparison_factor.filter(
																comparison_factor_appraise =>
														...
														<td
															v-for="(asset, index) in apartment.assets_general"
															:key="'assetHuongChinh' + index"
														>
															<span
																v-for="(comparison_factor,
																indexItem) in apartment.comparison_factor[index]
																	.comparison_factor"
																:key="'huongchinh2' + indexItem"
															>
																<span
																	v-if="
																		comparison_factor.type === 'huong_chinh'
																	"
																>
																	{{
																		formatSentenceCase(
													...
													>
														...
														<td
															v-for="(asset,
															indexAsset) in apartment.assets_general"
															:key="'inputHuongChinh' + indexAsset"
														>
															<div
																v-for="(comparison_factor, index) in apartment
																	.comparison_factor[indexAsset]
																	.comparison_factor"
																:key="'huongchinh4' + index"
															>
																<div
																	v-if="
																		comparison_factor.type === 'huong_chinh'
													...
													<tr
														...
														:key="'huongchinh5' + index"
													>
														<td>Mức điều chỉnh</td>
														<td></td>
														<td>
															{{
																formatNumber(parseFloat(priceHC1).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceHC2).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceHC3).toFixed(0))
															}}
														</td>
													</tr>
													<tr
														...
														:key="'huongchinh6' + index"
													>
														<td><strong>Giá sau điều chỉnh</strong></td>
														<td></td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["huong_chinh"][0])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["huong_chinh"][1])
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(adjustPriceData["huong_chinh"][2])
															}}</strong>
														</td>
													</tr>
													...
													>
														...
														<td><strong>Tình trạng nội thất</strong></td>
														<td
															v-for="(comparison_factor_appraise,
															index) in apartment.comparison_factor[0].comparison_factor.filter(
																comparison_factor_appraise =>
														...
														<td
															v-for="(asset, index) in apartment.assets_general"
															:key="'assetTinhTrangNoiThat' + index"
														>
															<span
																v-for="(comparison_factor,
																indexItem) in apartment.comparison_factor[index]
																	.comparison_factor"
																:key="'tinhtrangnoithat2' + indexItem"
															>
																<span
																	v-if="
																		comparison_factor.type ===
													...
													>
														...
														<td
															v-for="(asset,
															indexAsset) in apartment.assets_general"
															:key="'inputTinhTrangNoiThat' + indexAsset"
														>
															<div
																v-for="(comparison_factor, index) in apartment
																	.comparison_factor[indexAsset]
																	.comparison_factor"
																:key="'tinhtrangnoithat4' + index"
															>
																<div
																	v-if="
																		comparison_factor.type ===
													...
													<tr
														...
														:key="'tinhtrangnoithat5' + index"
													>
														<td>Mức điều chỉnh</td>
														<td></td>
														<td>
															{{
																formatNumber(parseFloat(priceTTNT1).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceTTNT2).toFixed(0))
															}}
														</td>
														<td>
															{{
																formatNumber(parseFloat(priceTTNT3).toFixed(0))
															}}
														</td>
													</tr>
													<tr
													...
													>
														...
														<td>
															<strong>{{
																formatNumber(
																	adjustPriceData["tinh_trang_noi_that"][0]
																)
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(
																	adjustPriceData["tinh_trang_noi_that"][1]
																)
															}}</strong>
														</td>
														<td>
															<strong>{{
																formatNumber(
																	adjustPriceData["tinh_trang_noi_that"][2]
																)
															}}</strong>
														</td>
													</tr>
													...
													<tr
														...
														"
														v-for="(data_appraise,
														index) in data_other_comparison || []"
														:key="'yeu_to_khac' + index"
													>
														<td style="padding: unset" colspan="6">
															<table
																class="table_of_other_comparison color_content"
															>
																	...
																	>
																		<div>
																			<InputPercentNegative
																				...
																				:text_center="true"
																				@change="
																					changeOtherRate($event, rate_asset)
																				"
																			/>
																		</div>
																	</td>
													...
													<tr>
														...
														<td
															...
															"
														>
															Mức độ chênh lệch với mức giá trung bình của các
															mức giá chỉ dẫn (%)
														</td>
														<td
															:class="
																mgcl1 > 15 || mgcl1 < -15 ? 'text-danger' : ''
															"
														>
															{{ mgcl1 + "%" }}
														</td>
													...
													<tr>
														...
														<td>
															{{ formatNumber(parseFloat(tldcg1).toFixed(0)) }}
														</td>
														<td>
															{{ formatNumber(parseFloat(tldcg2).toFixed(0)) }}
														</td>
														<td>
															{{ formatNumber(parseFloat(tldcg3).toFixed(0)) }}
														</td>
													</tr>
													<tr>
														<td>6</td>
													...
													<tr>
														...
														<td
															v-for="(asset,
															index_asset) in apartment.assets_general"
															...
															>
																<span v-if="percent.id === asset.id">
																	{{
																		...
																		)} - ${checkMax(area_adjusted[asset.id])}`
																	}}
																</span>
															</div>
														</td>
													...
													<tr>
														...
														<td>
															{{ formatNumber(parseFloat(tldc1).toFixed(0)) }}
														</td>
														<td>
															{{ formatNumber(parseFloat(tldc2).toFixed(0)) }}
														</td>
														<td>
															{{ formatNumber(parseFloat(tldc3).toFixed(0)) }}
														</td>
													</tr>
													<tr>
														<td>9</td>
														...
														<td colspan="3" align="center">
															<strong
																>{{
																	formatNumber(parseFloat(mgtn).toFixed(0))
																}}đ</strong
															>
														</td>
													</tr>
													<tr>
														...
														<td colspan="2">
															<div
																class="d-flex col-12 col-lg-12 container_round"
															>
														...
														<td colspan="3" align="center">
															{{
																formatNumber(
																	formatCurrent(parseFloat(mgtn).toFixed(0))
																)
															}}đ
														</td>
													</tr>
																...
																<tr>
																	...
																	<td>
																		{{
																			data.apartment_asset_properties
																				? formatNumber(
																						data.apartment_asset_properties.area
																				  )
																				: ""
																		}}
																	</td>
	...
	methods: {
		roundPrice(value, roundPrice) {
			...
			if (roundPrice && roundPrice > 0) {
				...
				console.log(
					"divide_value.toString(),divide_value.toString().length,check_part,check_var",
		...
		showUtility(apartment_specification) {
			if (
				apartment_specification &&
				apartment_specification.utility_description &&
				apartment_specification.utility_description.length > 0
			) {
				return this.converArrayToString(
					apartment_specification.utility_description
				);
			} else return "-";
		},
		...
		changePercentSaleRating(event, index) {
			if (event) {
				...
				this.form.apartment_adapter[index].change_negotiated_price =
					(this.form.assets_general[index].total_amount * event) / 100 -
					this.form.assets_general[index].total_amount;
		...
		changeNegotiatedPrice(event, index) {
			...
			if (event) {
				this.form.apartment_adapter[index].change_negotiated_price = event;
				this.form.apartment_adapter[index].percent = (
					((this.form.assets_general[index].total_amount + event) /
						this.form.assets_general[index].total_amount) *
					100
				).toFixed(2);
			...
			if (appraise.assets_general) {
				...
				appraise.assets_general.forEach(assets_general => {
					...
					const comparison_factor_TSSS = appraise.comparison_factor.filter(
						comparison => comparison.asset_general_id === assets_general.id
					);
					asset_generals.push({
		...
		async handleSaveSummarization(payloadData) {
			...
			const res = await CertificateAsset.submitApartmentStep5(
				payloadData,
				this.idData
			);
			if (res.data) {
		...
		changeLegalCoefficient(e, indexAsset, type) {
			...
			let factor = this.apartment.comparison_factor[
				indexAsset
		...
		calculation(asset) {
			...
			// thông tin TSSS
			let asset1 =
				typeof asset.assets_general[0] !== "undefined"
					? asset.assets_general[0]
					: null;
			let asset2 =
				typeof asset.assets_general[1] !== "undefined"
					? asset.assets_general[1]
					: null;
			let asset3 =
				typeof asset.assets_general[2] !== "undefined"
					? asset.assets_general[2]
					: null;

			// tỉ lệ giá rao bán
			let asset_percent1 =
				typeof asset.apartment_adapter[0] !== "undefined"
					? asset.apartment_adapter[0].percent
					: null;
			let asset_percent2 =
				typeof asset.apartment_adapter[1] !== "undefined"
					? asset.apartment_adapter[1].percent
					: null;
			let asset_percent3 =
				typeof asset.apartment_adapter[2] !== "undefined"
					? asset.apartment_adapter[2].percent
					: null;

			let asset_neo_price1 =
				typeof asset.apartment_adapter[0] !== "undefined"
					? asset.apartment_adapter[0].change_negotiated_price
					: null;
			let asset_neo_price2 =
				typeof asset.apartment_adapter[1] !== "undefined"
					? asset.apartment_adapter[1].change_negotiated_price
					: null;
			let asset_neo_price3 =
				typeof asset.apartment_adapter[2] !== "undefined"
					? asset.apartment_adapter[2].change_negotiated_price
					: null;
			...
			this.dgcc1 =
				asset1.room_details && asset1.room_details.length > 0
					? this.totalPriceEstimate1 / asset1.room_details[0].area
					: 0;
			this.dgcc2 =
				asset2.room_details && asset2.room_details.length > 0
					? this.totalPriceEstimate2 / asset2.room_details[0].area
					: 0;
			this.dgcc3 =
				asset3.room_details && asset3.room_details.length > 0
					? this.totalPriceEstimate3 / asset3.room_details[0].area
					: 0;
			...
			this.priceLch3 = 0;
			if (
				typeof comparisonFactor1["loai_can"] !== "undefined" &&
				comparisonFactor1["loai_can"].status === 1
			) {
				...
				let price1 = this.roundPrice(
					(percentLch1 * this.totalPricePL1) / 100,
					0
				);
				let price2 = this.roundPrice(
					(percentLch2 * this.totalPricePL2) / 100,
					0
				);
				let price3 = this.roundPrice(
					(percentLch3 * this.totalPricePL3) / 100,
					0
				);
			...
			this.priceLcho3 = 0;
			if (
				typeof comparisonFactor1["loai_can_ho"] !== "undefined" &&
				comparisonFactor1["loai_can_ho"].status === 1
			) {
				let percentLcho1 =
					+comparisonFactor1["loai_can_ho"].adjust_percent || 0;
				let percentLcho2 =
					+comparisonFactor2["loai_can_ho"].adjust_percent || 0;
				let percentLcho3 =
					+comparisonFactor3["loai_can_ho"].adjust_percent || 0;

				// mức điều chỉnh của yếu tố LOẠI CĂN HỘ
				let price1 = this.roundPrice(
					(percentLcho1 * this.totalPricePL1) / 100,
					0
				);
				let price2 = this.roundPrice(
					(percentLcho2 * this.totalPricePL2) / 100,
					0
				);
				let price3 = this.roundPrice(
					(percentLcho3 * this.totalPricePL3) / 100,
					0
				);
				...
				adjustPrice2 += price2;
				adjustPrice3 += price3;
				this.adjustPriceData["loai_can_ho"] = [
					adjustPrice1,
					adjustPrice2,
					adjustPrice3
				];
			...
			this.priceDt3 = 0;
			if (
				typeof comparisonFactor1["dien_tich"] !== "undefined" &&
				comparisonFactor1["dien_tich"].status === 1
			) {
				...
				let price1 = this.roundPrice(
					(percentDt1 * this.totalPricePL1) / 100,
					0
				);
				let price2 = this.roundPrice(
					(percentDt2 * this.totalPricePL2) / 100,
					0
				);
				let price3 = this.roundPrice(
					(percentDt3 * this.totalPricePL3) / 100,
					0
				);
				...
				adjustPrice2 += price2;
				adjustPrice3 += price3;
				this.adjustPriceData["dien_tich"] = [
					adjustPrice1,
					adjustPrice2,
					adjustPrice3
				];
			...
			this.priceSt3 = 0;
			if (
				typeof comparisonFactor1["tang"] !== "undefined" &&
				comparisonFactor1["tang"].status === 1
			) {
				...
				let price1 = this.roundPrice(
					(percentSt1 * this.totalPricePL1) / 100,
					0
				);
				let price2 = this.roundPrice(
					(percentSt2 * this.totalPricePL2) / 100,
					0
				);
				let price3 = this.roundPrice(
					(percentSt3 * this.totalPricePL3) / 100,
					0
				);
			...
			this.pricePWC3 = 0;
			if (
				typeof comparisonFactor1["so_phong_wc"] !== "undefined" &&
				comparisonFactor1["so_phong_wc"].status === 1
			) {
				...
				let price1 = this.roundPrice(
					(percentPWC1 * this.totalPricePL1) / 100,
					0
				);
				let price2 = this.roundPrice(
					(percentPWC2 * this.totalPricePL2) / 100,
					0
				);
				let price3 = this.roundPrice(
					(percentPWC3 * this.totalPricePL3) / 100,
					0
				);
				...
				adjustPrice2 += price2;
				adjustPrice3 += price3;
				this.adjustPriceData["so_phong_wc"] = [
					adjustPrice1,
					adjustPrice2,
					adjustPrice3
				];
			...
			this.pricePn3 = 0;
			if (
				typeof comparisonFactor1["so_phong_ngu"] !== "undefined" &&
				comparisonFactor1["so_phong_ngu"].status === 1
			) {
				...
				let price1 = this.roundPrice(
					(percentPn1 * this.totalPricePL1) / 100,
					0
				);
				let price2 = this.roundPrice(
					(percentPn2 * this.totalPricePL2) / 100,
					0
				);
				let price3 = this.roundPrice(
					(percentPn3 * this.totalPricePL3) / 100,
					0
				);
				...
				adjustPrice2 += price2;
				adjustPrice3 += price3;
				this.adjustPriceData["so_phong_ngu"] = [
					adjustPrice1,
					adjustPrice2,
					adjustPrice3
				];
			...
			this.priceHC3 = 0;
			if (
				typeof comparisonFactor1["huong_chinh"] !== "undefined" &&
				comparisonFactor1["huong_chinh"].status === 1
			) {
				let percentHC1 = +comparisonFactor1["huong_chinh"].adjust_percent || 0;
				let percentHC2 = +comparisonFactor2["huong_chinh"].adjust_percent || 0;
				let percentHC3 = +comparisonFactor3["huong_chinh"].adjust_percent || 0;

				// mức điều chỉnh của yếu tố WC
				let price1 = this.roundPrice(
					(percentHC1 * this.totalPricePL1) / 100,
					0
				);
				let price2 = this.roundPrice(
					(percentHC2 * this.totalPricePL2) / 100,
					0
				);
				let price3 = this.roundPrice(
					(percentHC3 * this.totalPricePL3) / 100,
					0
				);
				this.priceHC1 = price1;
				this.priceHC2 = price2;
				this.priceHC3 = price3;
				adjustPrice1 += price1;
				adjustPrice2 += price2;
				adjustPrice3 += price3;
				this.adjustPriceData["huong_chinh"] = [
					adjustPrice1,
					adjustPrice2,
					adjustPrice3
				];

				this.comparisonFactorChange1 += percentHC1 !== 0 ? 1 : 0;
				this.comparisonFactorChange2 += percentHC2 !== 0 ? 1 : 0;
				this.comparisonFactorChange3 += percentHC3 !== 0 ? 1 : 0;
			}
			...
			this.priceTTNT3 = 0;
			if (
				typeof comparisonFactor1["tinh_trang_noi_that"] !== "undefined" &&
				comparisonFactor1["tinh_trang_noi_that"].status === 1
			) {
				let percentTTNT1 =
					+comparisonFactor1["tinh_trang_noi_that"].adjust_percent || 0;
				let percentTTNT2 =
					+comparisonFactor2["tinh_trang_noi_that"].adjust_percent || 0;
				let percentTTNT3 =
					+comparisonFactor3["tinh_trang_noi_that"].adjust_percent || 0;

				// mức điều chỉnh của yếu tố WC
				let price1 = this.roundPrice(
					(percentTTNT1 * this.totalPricePL1) / 100,
					0
				);
				let price2 = this.roundPrice(
					(percentTTNT2 * this.totalPricePL2) / 100,
					0
				);
				let price3 = this.roundPrice(
					(percentTTNT3 * this.totalPricePL3) / 100,
					0
				);
				this.priceTTNT1 = price1;
				this.priceTTNT2 = price2;
				this.priceTTNT3 = price3;
				adjustPrice1 += price1;
				adjustPrice2 += price2;
				adjustPrice3 += price3;
				this.adjustPriceData["tinh_trang_noi_that"] = [
					adjustPrice1,
					adjustPrice2,
					adjustPrice3
				];

				this.comparisonFactorChange1 += percentTTNT1 !== 0 ? 1 : 0;
				this.comparisonFactorChange2 += percentTTNT2 !== 0 ? 1 : 0;
				this.comparisonFactorChange3 += percentTTNT3 !== 0 ? 1 : 0;
			}
			...
			this.tldcg1 =
				...
				Math.abs(this.pricePn1) +
				Math.abs(this.priceLch1) +
				Math.abs(this.priceLcho1) +
				Math.abs(this.priceDt1) +
				Math.abs(this.priceSt1) +
				Math.abs(this.pricePWC1) +
				Math.abs(this.priceHC1) +
				Math.abs(this.priceTTNT1) +
				Math.abs(mgcd_price_other_abs[0]);
			this.tldcg2 =
				Math.abs(this.pricePl2) +
				Math.abs(this.pricePn2) +
				Math.abs(this.priceLch2) +
				Math.abs(this.priceLcho1) +
				Math.abs(this.priceDt2) +
				Math.abs(this.priceSt2) +
				Math.abs(this.pricePWC2) +
				Math.abs(this.priceHC2) +
				Math.abs(this.priceTTNT2) +
				Math.abs(mgcd_price_other_abs[1]);
			this.tldcg3 =
				Math.abs(this.pricePl3) +
				Math.abs(this.pricePn3) +
				Math.abs(this.priceLch3) +
				Math.abs(this.priceLcho1) +
				Math.abs(this.priceDt3) +
				Math.abs(this.priceSt3) +
				Math.abs(this.pricePWC3) +
				Math.abs(this.priceHC3) +
				Math.abs(this.priceTTNT3) +
			...
			this.mgtb =
				asset.assets_general.length > 0
					? (this.mgcd1 + this.mgcd2 + this.mgcd3) / asset.assets_general.length
					: 0;
			let arrayMGTN = [this.mgcd1, this.mgcd2, this.mgcd3];
			if (
				this.form.appraisal_methods &&
				this.form.appraisal_methods.thong_nhat_muc_gia_chi_dan.slug_value ===
					"thap-nhat"
			) {
