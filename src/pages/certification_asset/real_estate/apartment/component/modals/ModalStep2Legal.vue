            ...
            <div class="row">
              <div class="col-12 col-xl-6">
                <div class="row flex-column h-100">
                  ...
                  <div v-if="form.appraise_law_id === 0" class="col m-h-100">
                    <InputText
                  ...
                  <div class="col m-h-100 input-contain">
                    <InputText
                  ...
                  <div class="col m-h-100 input-contain" v-if="form.appraise_law_id !== 0">
                    <InputText
              ...
              <div class="col-12 col-xl-6">
                <div class="row flex-column h-100">
                  ...
                  <div class="col m-h-100" v-if="form.appraise_law_id !== 0">
                    <InputText
...
export default {
	...
	props: ['data', 'juridicals', 'provinceName', 'full_address', 'apartment_name'],
	components: {
		InputCategory,
		InputText,
		InputTextarea,
	...
	methods: {
		changeLegalDate (event) {
			if (event) { this.form.document_date = event }
		},
		changeLegal () {
			this.getContent()
		},
		async getContent () {
			this.form.content = 'Chứng nhận ' + `${this.form.legal_name_holder ? this.form.legal_name_holder + ' ' : ''}` + 'được quyền sở hữu ' + this.apartment_name + `${this.full_address ? ' tại địa chỉ ' + this.full_address : ''}.`
		},
		getProvince () {
		...
		async validateLegal () {
			...
			if (valid) {
				...
				this.form.law_document = getLaw[0]
