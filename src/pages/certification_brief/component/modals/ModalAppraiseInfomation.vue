        ...
        <div class="card">
          ...
          <div class="contain-detail">
            ...
            <div class="row">
              ...
              <div class=" d-lg-flex d-block justify-content-end align-items-center mt-3 mb-2">
                <div class="d-lg-flex d-block button-contain">
                  ...
                  <button class="btn btn-orange btn-action-modal" type="submit"> <img src="@/assets/icons/ic_save.svg" style="margin-right: 12px" alt="save"> Lưu</button>
                </div>
              </div>
            </ValidationObserver>
          </div>
...
export default {
	...
	methods: {
		...
		changeDocumentDate (event) {
			...
			if (event && event !== '') {
				if (moment(this.form.document_date).endOf('day') < moment(this.form.certificate_date)) {
