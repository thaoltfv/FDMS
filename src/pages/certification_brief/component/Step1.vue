      ...
      <div class="card">
        <div class="card-title">
          <div class="d-flex justify-content-between align-items-center">
            <h3 class="title">
              {{ this.$route.name === "certification_brief.edit" ? "Chỉnh sửa hồ sơ thẩm định" : "Tạo mới hồ sơ thẩm định" }}
            </h3>
      ...
      <div class="card">
        <div class="card-title">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <img
              class="img-dropdown"
              :class="!showCardDetailEconomicAndSocial ? 'img-dropdown__hide' : ''"
              src="../../../assets/images/icon-btn-down.svg"
              alt="dropdown"
              @click="showCardDetailEconomicAndSocial = !showCardDetailEconomicAndSocial"
            />
          </div>
        </div>
        <div
...
export default {
	...
	methods: {
		...
		async handleChangeCustomer (event) {
			...
			let bindCustomer = await this.customers.filter(
				(item) => item.id === event
			)
