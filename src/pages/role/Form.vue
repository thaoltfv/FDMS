    ...
    <ValidationObserver tag="form"
      ...
      <div class="card mb-3">
        <div class="card-body">
          <div class="row">
            <!--Display name role-->
            <InputText v-model="form.role_name"
          ...
          <p class="mt-2 text-warning">! Thay đổi phân quyền có thể ảnh hưởng đến các chức năng khác</p>
        </div>
      </div>
        ...
        <table class="table permission-table" ref="table">
          ...
          <tr>
            ...
            <th>
              <div class="d-flex justify-content-start align-items-center" >
                <label class="input-checkbox m-0 mr-2">
                  <input type="checkbox" @click="selectAll('VIEW')" v-model="viewSelected">
            ...
            <th>
              <div class="d-flex justify-content-start align-items-center" >
                <label class="input-checkbox m-0 mr-2">
                  <input type="checkbox" @click="selectAll('ADD')" v-model="addSelected">
                  <span class="check-mark"></span>
                </label>
                <p class="mb-0">Thêm</p>
              </div>
            ...
            <th class="text-center">
              <div class="d-flex justify-content-start align-items-center" >
                <label class="input-checkbox m-0 mr-2">
                  <input type="checkbox" @click="selectAll('EDIT')" v-model="editSelected">
                  <span class="check-mark"></span>
                </label>
                <p class="mb-0">Sửa</p>
              </div>
            ...
            <th class="text-center">
              <div class="d-flex justify-content-start align-items-center" >
                <label class="input-checkbox m-0 mr-2">
                  <input type="checkbox" @click="selectAll('DELETE')" v-model="deleteSelected">
                  <span class="check-mark"></span>
                </label>
                <p class="mb-0">Xóa</p>
              </div>
            ...
            <th class="text-center">
              <div class="d-flex justify-content-start align-items-center" >
                <label class="input-checkbox m-0 mr-2">
                  <input type="checkbox" @click="selectAll('ACCEPT')" v-model="acceptSelected">
                  <span class="check-mark"></span>
                </label>
            ...
            <th class="text-center">
              <div class="d-flex justify-content-start align-items-center" >
                <label class="input-checkbox m-0 mr-2">
                  <input type="checkbox" @click="selectAll('EXPORT')" v-model="exportSelected">
                  <span class="check-mark"></span>
                </label>
      ...
      <div class="btn-footer d-md-flex d-block justify-content-end align-items-center">
        <div class="d-lg-flex d-block button-contain">
          <button @click="onCancel" type="button" class="btn btn-white text-nowrap" :class="{'disabled': isSubmit}">
	...
	methods: {
		...
		selectAll (permission) {
			...
			case 'DELETE':
				...
				if (this.deletePermissions.length === this.screens.length) { this.deleteSelected = true }
				break
			case 'ACCEPT':
				...
				if (this.acceptPermissions.length === this.screens.length) { this.acceptSelected = true }
				break
			case 'EXPORT':
				...
				if (this.exportPermissions.length === this.screens.length) { this.exportSelected = true }
				break
			}
		},
		select (permission) {
		...
		change (permission) {
			...
			case 'DELETE':
				...
				break
			case 'ACCEPT':
				if (this.acceptPermissions.length === this.screens.length) { this.accpetSelected = true }
				break
			case 'EXPORT':
				if (this.exportPermissions.length === this.screens.length) { this.exportSelected = true }
				break
