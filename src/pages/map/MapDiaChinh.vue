<template>
	<div class="main-wrapper-new main-wrapper modal-delete d-flex justify-content-center align-items-center">
...
;"/>
    ...
    margin-left: -10px;">
		...
		>
			<div class="card" :style="{ 'width': resizeWidth }">
    ...
    width: 50px;">
				...
				<div class="main-map" :style="{ 'width': resizeWidth }">
