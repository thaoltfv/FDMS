		...
		onEachFeatureFunction() {
			return (feature, layer) => {
				...
				if (
					this.map.zoom >= 17 &&
					this.map.zoom < 18 &&
					feature.properties.length > 60 &&
					!layer.getTooltip()
				) {
					// // console.log('vô vẽ nè 1',feature.properties.length.toFixed(1))
					layer.bindTooltip(
						"<div class='test' style='transform: rotate(" +
							feature.angle +
							"deg); padding-top: 20px; font-size: " +
							m_font_size +
							"; font-weight: " +
							m_font_weight +
							"; color: " +
				...
				if (
					...
					layer.bindTooltip(
						"<div class='test' style='transform: rotate(" +
							feature.angle +
							"deg); padding-top: 25px; font-size: " +
							m_font_size +
							"; font-weight: " +
							m_font_weight +
							"; color: " +
				...
				if (
					...
					layer.bindTooltip(
						"<div class='test' style='transform: rotate(" +
							feature.angle +
							"deg); padding-top: 30px; font-size: " +
							m_font_size +
							"; font-weight: " +
							m_font_weight +
							"; color: " +
				...
				if (
					...
					layer.bindTooltip(
						"<div class='test' style='transform: rotate(" +
							feature.angle +
							"deg); padding-top: 35px; font-size: " +
							m_font_size +
							"; font-weight: " +
							m_font_weight +
							"; color: " +
					...
					await File.getInfoByLand({ data: formdata }).then(response => {
						...
						if (
							...
							for (let i = 0; i < this.seg_data.length; i++) {
								...
								let y =
									Math.sin((l2 - l1) * toRadian) * Math.cos(f2 * toRadian);
								let x =
