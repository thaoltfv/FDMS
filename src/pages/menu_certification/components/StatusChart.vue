  ...
  <div>
      <div class="card">
        ...
        <div class="card-body card-info" >
          <div class="row">
            <div class="col-12">
              <DoughnutChart :key="render_doughnut_key" ref="chart_doughnut" :text_center="chartDoughnut.total" :data="chartDoughnut" :options="chartDoughnutOptions"  />
            </div>
          </div>
        </div>
      </div>
...
export default {
	...
	methods: {
		async getDataReport () {
			const res = await Report.getReportStatus(this.form)
