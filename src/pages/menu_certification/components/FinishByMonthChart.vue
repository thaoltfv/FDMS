...
export default {
	...
	async mounted() {
		await this.getDataCertificationFinishByMonth();
	},
	methods: {
		async getDataCertificationFinishByMonth() {
			let dataset = [];
			this.chartBar.datasets = [];
			this.chartBar.labels = [];
			const res = await Report.getReportCertificationFinishByMonthCustomerGroup();
