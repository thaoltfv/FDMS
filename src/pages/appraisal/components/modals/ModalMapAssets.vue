        ...
        <div class="main-map">
          <!-- <div id="mapid" class="layer-map">
            <l-map ref="lmap"
                   style="height: 100%;"
                   :zoom="map.zoom"
                   :center="[assets[0].coordinates.split(',')[0], assets[0].coordinates.split(',')[1]]"
                   :maxZoom="20"
            ...
            >
              ...
              <l-control position="bottomleft">
                ...
                <l-marker v-for="asset in assets" :key="asset.id" :lat-lng="[asset.coordinates.split(',')[0], asset.coordinates.split(',')[1]]">
                ...
                <l-marker v-for="asset in assetArray" :key="'array' + asset.id" :lat-lng="[asset.coordinates.split(',')[0], asset.coordinates.split(',')[1]]">
                  <l-icon class-name="someExtraClass">
                  ...
                  <l-tooltip class="sp-custom-popup" ref="popup">
                    <div class="d-flex justify-content-between">
                      <p class="popup-name">Mã:</p>
                      <p class="popup-content popup-content__id">{{ 'TSTD_' + asset.id }}</p>
                    </div>
                    <div class="d-flex justify-content-between">
                      <p class="popup-name">Loại tài sản:</p>
                      <p class="popup-content">{{asset.asset_type.description}}</p>
                    </div>
                  </l-tooltip>
                </l-marker>
            </l-map>
          ...
          <div id="mapid" class="layer-map">
            ...
            >
              ...
              <l-control position="bottomleft">
                ...
                <l-marker v-for="(asset, index) in assets" :key="asset.id" :lat-lng="[asset.coordinates.split(',')[0], asset.coordinates.split(',')[1]]">
                  <!-- <l-icon class-name="someExtraClass">
                    <div class="marker marker__blue"/>
                  </l-icon> -->
                  <l-icon :iconAnchor="[30, 60]" >
                  <!-- <div class="marker marker__blue"/> -->
                    <img v-if="index === 0" class="asset_icon"  src="../../../../assets/images/svg_marker_1.svg" alt="">
                    <img v-if="index === 1" class="asset_icon" src="../../../../assets/images/svg_marker_2.svg" alt="">
                    <img v-if="index === 2" class="asset_icon" src="../../../../assets/images/svg_marker_3.svg" alt="">
                  ...
                  <!-- <l-tooltip class="sp-custom-popup" ref="popup" :options="{ permanent: true, interactive: true }">
                    <p class="popup-content__id mb-0">{{`TSSS ${index + 1}`}}</p>
                  </l-tooltip> -->
                </l-marker>
                <l-marker :lat-lng="[assetArray.coordinates.split(',')[0], assetArray.coordinates.split(',')[1]]">
                  <l-icon class-name="someExtraClass" :iconAnchor="[30, 60]">
                    <img class="asset_icon"  src="../../../../assets/images/svg_home.svg" alt="">
                  </l-icon>
                  <!-- <l-tooltip class="sp-custom-popup" ref="popup">
                    <div class="d-flex justify-content-between">
                      <p class="popup-name">Mã:</p>
                      <p class="popup-content popup-content__id">{{ 'TSTD_' + assetArray.id }}</p>
                    </div>
                    <div class="d-flex justify-content-between">
                      <p class="popup-name">Loại tài sản:</p>
                      <p class="popup-content">{{assetArray.asset_type.description}}</p>
                    </div>
                  </l-tooltip> -->
                   <!-- <l-tooltip class="sp-custom-popup" ref="popup" :options="{ permanent: true, interactive: true }">
                    <p class="popup-content__id mb-0">{{`TSTD_${assetArray.id}`}}</p>
                  </l-tooltip> -->
                </l-marker>
            </l-map>
          </div>
...
export default {
	name: 'ModalMap',
	props: ['location', 'assets', 'center_map', 'assetArray'],
	components: {
