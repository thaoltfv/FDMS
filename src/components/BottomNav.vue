      ...
      >
        <div class="active-label">
          ...
          <slot name="icon" :props="button">
            <icon-base :name="button.icon" v-if="button.customImage" width="20px" height="20px" class="item-icon svg-inline--fa" />
            <font-awesome-icon :icon="button.icon" class="item-icon" width="20px" height="20px" v-else />
          </slot>
        </div>
          ...
          <div class="btn-child-parent">
            ...
            >
              <slot name="child-icon" :props="child">
                <icon-base :name="child.icon" v-if="child.customImage" width="20px" height="20px" class="item-icon svg-inline--fa" />
                <font-awesome-icon :icon="child.icon" class="item-icon" width="20px" height="20px" v-else />
              </slot>
