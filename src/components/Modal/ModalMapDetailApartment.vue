					...
					<div class="card-table">
						...
						<div class="card-body card-info card-land" v-if="show_description">
							...
							<div
								...
								v-if="property.ward && property.district && property.province"
							>
					...
					<div class="card-table">
						...
						>
							<div class="property-content row">
								...
								<p class="property-detail col">
									{{
										property.apartment_asset_properties.block !== undefined &&
										property.apartment_asset_properties.block !== null
											? property.apartment_asset_properties.block.name
											: "Chưa có thông tin"
									}}
								</p>
							</div>
							<div class="property-content row">
								...
								<p class="property-detail col">
									{{
										property.apartment_asset_properties.apartment_name
											? property.apartment_asset_properties.apartment_name
											: "Chưa có thông tin"
									}}
								</p>
							...
							<div class="property-content row">
								...
								<p class="property-detail col">
									{{
										property.apartment_asset_properties.block
											? property.apartment_asset_properties.block.total_floors
											: "Chưa có thông tin"
									}}
								</p>
							</div>
							<div class="property-content row">
								...
								<p class="property-detail col">
									{{ property.apartment_asset_properties.area }} m<sup>2</sup>
								</p>
							</div>
							<div class="property-content row">
								<p class="property-title col-4">Số phòng ngủ:</p>
								<p class="property-detail col">
									{{ property.apartment_asset_properties.bedroom_num }}
								</p>
							</div>
							<div class="property-content row">
								...
								<p class="property-detail col">
									{{
										property.apartment_asset_properties.direction
											? property.apartment_asset_properties.direction
													.description
											: "Chưa có thông tin"
									}}
...
export default {
	...
	computed: {
		totalPrice() {
			let price = 0;
			let round = 0;
			let priceData = this.property.price.find(
				i => i.slug === "apartment_total_price"
			);
		...
		unitPrice() {
			...
			let round = 0;
			let priceData = this.property.price.find(
				i => i.slug === "apartment_asset_price"
			);
			let roundData = this.property.price.find(i => i.slug === "round_total");
			if (priceData) {
				price = priceData.value;
