												...
												>
													...
													>
														...
														<div class="content_detail color_content">
															{{
																formatNumberArea(
																	assetDetails.room_details[0].area
																)
															}}
															m<sup>2</sup>
														</div>
													...
													>
														...
														<div class="content_detail color_content">
															{{
																formatNumberArea(
																	assetDetails.average_land_unit_price
																)
															}}
															đ
														</div>
														...
														<TabItem name="Thông tin chung cư">
															<div class="row content_detail_asset">
																...
																>
																	...
																	<div class="content_detail color_content">
																		{{
																			assetDetails.project
																				? assetDetails.project.name
																				: ""
																		}}
																	</div>
																</div>
																...
																>
																	...
																	<div class="content_detail color_content">
																		{{
																			assetDetails.project
																				? assetDetails.project.total_blocks
																				: ""
																		}}
																	</div>
																</div>
																...
																>
																	...
																	<div class="content_detail color_content">
																		{{
																			assetDetails.project
																				? assetDetails.project.total_apartments
																				: ""
																		}}
																	</div>
																</div>
																...
																>
																	...
																	<div class="content_detail color_content">
																		{{
																			assetDetails.room_details &&
																			assetDetails.room_details.length > 0
																				? assetDetails.room_details[0].legal_id
																					? "Có sổ"
																					: "Không có sổ"
																				: "Không có"
																		}}
																...
																>
																	...
																	<div class="content_detail color_content">
																		{{
																			assetDetails.project
																				? assetDetails.project.handover_year
																				: ""
																		}}
																	</div>
																</div>
														...
														<TabItem class="item_2" name="Thông tin căn hộ">
															<div class="row content_detail_asset">
																...
																>
																	...
																	<div class="content_detail color_content">
																		{{
																			assetDetails.apartment_specification
																				? assetDetails.apartment_specification
																						.apartment_name
																				: ""
																		}}
																...
																>
																	...
																	<div class="content_detail color_content">
																		{{
																			assetDetails.room_details &&
																			assetDetails.room_details.length > 0
																				? assetDetails.room_details[0].wc_num
																				: ""
																		}}
																	</div>
																</div>
...
import ModalDetailSelectedAssetApartment from "./modals/ModalDetailSelectedAssetApartment";
import ModalFilterMapApartment from "./modals/ModalFilterMapApartment";
	...
	methods: {
		...
		handleChangeRouter() {
			const routeData = this.$router.resolve({
				...
				query: { asset_type_id: this.step_1.general_infomation.asset_type_id }
			});
		...
		async getListAsset() {
			...
			const getAllAsset = await CertificateAsset.getAllAssetApartment(
				distance,
				location,
				transaction,
				assetType,
		...
		async handleMarker(asset) {
			const data = [asset];
			const getDetailAsset = await CertificateAsset.getDetailAssetApartment(
				data
			);
		...
		async showDetailsSelectedAsset() {
			if (this.assetHasChoose.length === 0) {
				...
				this.assetHasChoose = this.assetHasChoose.sort((a, b) => b.id - a.id);
				const dataDetail = await CertificateAsset.getDetailAssetApartment(
					this.assetHasChoose
				);
				if (dataDetail.data) {
