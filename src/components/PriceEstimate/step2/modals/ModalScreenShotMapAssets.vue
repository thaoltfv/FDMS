					...
					<div class="container-note">
						<div class="mr-18 d-flex align-items-center">
							<img
								...
								src="@/assets/images/marker_empty.png"
								alt=""
							/>
							...
							>
								<l-icon :iconAnchor="[30, 60]">
									...
									<img
										...
										src="@/assets/images/svg_marker_1.svg"
										alt=""
									/>
									<img
										v-if="index === 1"
										...
										src="@/assets/images/svg_marker_2.svg"
										alt=""
									/>
									<img
										v-if="index === 2"
										...
										src="@/assets/images/svg_marker_3.svg"
										alt=""
									/>
...
export default {
	...
	async mounted() {
		this.map.center = [
			this.coordinates.split(",")[0],
			this.coordinates.split(",")[1]
		];
		this.$nextTick(() => {
