            ...
            <div class="row col-lg-8">
              <div class="col-12 col-lg-6 pl-4 align-items-center" v-for="(itemFacility, indexFacility) in appraisalFacility" :key="indexFacility">
                <div class="d-flex form-group-container">
                  <input type="radio" :disabled="true" :name="itemFacility.type" :id="itemFacility.id" :value="itemFacility.id" v-model="data.value_base_and_approach.basis_property_id">
          ...
          <div class="row container_content pb-2">
            ...
            <div class="row col-lg-8">
              <div class="col-12 col-lg-6 pl-4 align-items-center" v-for="(itemPrinciple, indexPrinciple) in appraisalPrinciples" :key="indexPrinciple">
                <div class="d-flex form-group-container">
                  <input type="radio" :disabled="true" :name="itemPrinciple.type" :id="itemPrinciple.id" :value="itemPrinciple.id" v-model="data.value_base_and_approach.principle_id">
          ...
          <div class="row container_content pb-2">
            ...
            <div class="row col-lg-8">
              <div class="col-12 col-lg-6 pl-4 align-items-center" v-for="(itemApproach, indexApproach) in approach" :key="indexApproach">
                <div class="d-flex form-group-container">
                  <input type="radio" :disabled="true" :name="itemApproach.type" :id="itemApproach.id" :value="itemApproach.id" v-model="data.value_base_and_approach.approach_id">
          ...
          <div class="row container_content pb-2">
            ...
            <div class="row col-lg-8">
              <div class="col-12 col-lg-6 pl-4 align-items-center" v-for="(itemUsedMethod, indexUsedMethod) in methodsUsed" :key="indexUsedMethod">
                <div class="d-flex form-group-container">
                  <input type="radio" :disabled="true" :name="itemUsedMethod.type" :id="itemUsedMethod.id" :value="itemUsedMethod.id" v-model="data.value_base_and_approach.method_used_id">
            ...
            <div class="d-flex col-12 col-lg-4 color_content form-label font-weight-bold align-items-center form-group-container">Giả thiết và giả thiết đặc biệt</div>
              <div class="col-12 col-lg-8 align-items-center ">
                <InputTextarea
                  ...
                  v-model="data.value_base_and_approach.description"
                  rules="required"
                  vid="description"
                  :rows="3"
              ...
              <div class="col-12 col-lg-8" >
                <div class="row align-items-center">
                  <div class="col-12 col-lg-4 pl-4 align-items-center" v-for="(itemIndicative, indexIndicative) in unifyIndicativePrice" :key="indexIndicative">
                    <div class="d-flex">
                      <input type="radio" :disabled="true" :name="itemIndicative.slug" :id="itemIndicative.slug" :value="itemIndicative.slug" v-model="data.appraisal_methods.thong_nhat_muc_gia_chi_dan.slug_value">
