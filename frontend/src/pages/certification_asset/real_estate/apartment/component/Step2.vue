									...
									<table class="table_legal color_content">
										...
										<tbody>
											<tr v-for="(item, indexLaw) in data.law" :key="indexLaw">
												...
												<td>
													<p :id="`namelaw${item.id}`" class="name_law">{{ item.law_document ? item.law_document.content : item.description }}</p>
													<b-tooltip :target="('namelaw' + item.id).toString()">{{ item.law_document ? item.law_document.content : item.description}}</b-tooltip>
												</td>
												...
												<td>
													<div class="d-flex justify-content-center">
														...
														<div>
															<button class="btn-delete" type="button" @click="handleDeleteLegal(indexLaw)"><img
...
import ModalStep2Legal from './modals/ModalStep2Legal'
