          ...
          <div class="row">
            ...
            <div class="col-4">
              <div class="d-flex align-items-center">
                ...
                <p class="property_content">Đã bán</p>
              </div>
            </div>
            <div class="col-4">
              <div class="d-flex align-items-center">
                ...
                <p class="property_content">Rao bán</p>
              </div>
            </div>
            <div class="col">
              <div class="d-flex align-items-center">
                <label class="input_checkbox">
                  <input class="cursor-pointer" type="checkbox" v-model="filter_map.bothSide" @change="handleIsCheckBothSide">
                  <span class="check-mark"></span>
                </label>
                <p class="property_content">Mặt tiền & hẻm</p>
              </div>
            </div>
          </div>
        </div>
...
export default {
	name: 'ModalFilterMap',
	props: ['radius', 'frontSide', 'bothSide', 'transaction', 'assetType'],
	components: {
		InputText,
		InputNumberFormat
	},
