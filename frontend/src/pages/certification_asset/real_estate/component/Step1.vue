					...
					<div class="row">
						<div class="col-12 col-lg-7">
							<div class="row">
								...
								<div class="col-md-12 col-lg-6">
									<InputCategory
										v-model="data.general_infomation.street_id"
										vid="street_id"
										label="Đường/Phố"
										rules="required"
										class="form-group-container"
						...
						<div class="mt-2">
							...
							<div class="container-img row mr-0 ml-0">
								<div
									...
									"
									v-for="(images, index) in data.picture_infomation"
									:key="images.id"
								>
		...
		async getTheLastTurningTime() {
			if (this.addressName.street) {
				...
				let main_road_length = this.data.traffic_infomation
					...
					: 0;
				let streetName = "";
				let main_road_distance = this.data.traffic_infomation
