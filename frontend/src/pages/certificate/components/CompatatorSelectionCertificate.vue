      ...
      <div class="container-content__detail row align-items-center mb-0">
        ...
        <div class="col d-flex align-items-center">
          ...
          <div class="text-danger">
            Đã chọn {{comparison_factor.length}} yếu tố so sánh
          </div>
        </div>
      </div>
    </div>
    <ModalCompatatorSelectionCertificate
...
import ModalCompatatorSelectionCertificate from './modals/ModalCompatatorSelectionCertificate'
export default {
	...
	methods: {
		saveData (event) {
			this.$emit('saveComparison', event)
