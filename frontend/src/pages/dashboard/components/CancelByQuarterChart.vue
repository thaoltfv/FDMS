...
export default {
	...
	async mounted () {
		await this.getDataCertificationCancel()
	},
	methods: {
		async getDataCertificationCancel () {
			let dataset = []
			this.chartBar.datasets = []
			this.chartBar.labels = []
			const res = await Report.getReportCertificationCancelByQuarters()
