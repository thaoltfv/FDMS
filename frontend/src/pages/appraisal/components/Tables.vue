  ...
  <div class="table-detail position-relative empty-data">
    <a-table bordered
      ...
      <template slot="status" slot-scope="status">
        <p v-if="status === 1" :style="{color:'#000077'}" class="status text-none">Nháp</p>
        <p v-if="status === 2" :style="{color:'#610bec'}" class="status text-none">Mới</p>
        <p v-if="status === 3" :style="{color:'#CC6600'}" class="status text-none">Đang duyệt</p>
        <p v-if="status === 4" :style="{color:'#009933'}" class="status text-none">Đã duyệt</p>
