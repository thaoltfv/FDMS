								...
								<p class="text-none mb-0">
									{{
										...
										land.properties[0].property_detail.length > 0
											? land.properties[0].property_detail[0].land_type_purpose
													.acronym
											: ""
									}}
									{{
										...
										land.properties.length > 0 &&
										land.properties[0].property_detail &&
										land.properties[0].property_detail.length > 1
											? ", " +
											  land.properties[0].property_detail[1].land_type_purpose
													.acronym
											: ""
									}}
								</p>
...
export default {
	...
	methods: {
		...
		async handleAction(event) {
			...
			this.isSubmit = true;
			const res = await CertificationBrief.updateAppraiseCertificateVersion(
				this.idData,
				dataSend
			);
			if (res.data) {
