            ...
            <div class="card-table">
              ...
              <div class="card-body">
                <div class="container-img row mr-0 ml-0">
                  <div class="img-empty text-center" v-if="tangible.pic.length === 0">
                    <img src="../../assets/images/img_emply.svg" alt="empty">
                    <p class="empty-content"> Chưa có hình</p>
                  </div>
                  <div class="img-contain col-4 col-lg-2" v-for="images in tangible.pic" :key="images.id">
...
<!--              <p class="img-content">Hình ảnh</p>-->
<!--              <div class="img-contain" v-for="images in tangible.pic" :key="images.id">-->
