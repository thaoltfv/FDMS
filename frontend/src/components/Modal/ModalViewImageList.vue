  ...
  <div
    ...
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h3 class="font-weight-bold">Hình ảnh khách hàng</h3>
      ...
      <div class="card-body" v-if="picList.length > 0">
        ...
        <a :href="`/customer/detail?id=${id[activeName]}`" target="_blank" class="image-caption my-3">
          Thông tin khách hàng với mã số: <span class="link-detail">{{ id[activeName] }}</span>
        </a>
      </div>
      <div class="card-body" v-if="picList.length === 0">
