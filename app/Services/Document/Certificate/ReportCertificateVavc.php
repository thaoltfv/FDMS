...
class ReportCertificateVavc extends ReportCertificate
{
    ...
    protected function content1(Section $section, $certificate)
    {
        ...
        $section->addListItem("Ngày sinh: " . $certificate->petitioner_birthday ? date_create($certificate->petitioner_birthday)->format("dd/mm/YYYY") : '',0 , ['size' => '12.5'], 'bullets');
        ...
        $textRun = $section->addTextRun();
        $textRun->addText("2. Thông tin về tài sản thẩm định giá: ", ['size' => '12.5','bold' => true]);
        ...
        $textRun = $section->addTextRun();
        $textRun->addText("3. Thời điểm thẩm định giá: ", ['size' => '12.5','bold' => true]);
        ...
        $textRun1->addText("4. Mục đích thẩm định giá: ", ['size' => '12.5','bold' => true]);
        ...
        $textRun2->addText("5. Căn cứ pháp lý: ", ['size' => '12.5','bold' => true]);
        ...
        $textRun3->addText("6. Cơ sở giá trị của tài sản thẩm định giá: ", ['size' => '12.5','bold' => true]);
        $textRun3->addText("Cơ sở giá trị thị trường và phi thị trường.", ['size' => '12.5','bold' => false]);
        $textRun4 = $section->addTextRun();
        $textRun4->addText("7. Giả thiết và giả thiết đặc biệt: ", ['size' => '12.5','bold' => true]);
        ...
        $textRun5->addText("8. Cách tiếp cận, phương pháp thẩm định giá: ", ['size' => '12.5','bold' => true]);
        ...
        $textRun7->addText("11. Thời hạn có hiệu lực của kết quả thẩm định giá: ", ['size' => '12.5','bold' => true]);
        ...
        $textRun6 = $section->addTextRun();
        $textRun6->addText("12. Các tài liệu kèm theo: ", ['size' => '12.5','bold' => true]);
