...
class ReportCertificateVavc extends ReportCertificate
{
    ...
    {
        $section->addListItem("Căn cứ Hợp đồng thẩm định giá/Tờ trình thuê ngoài định giá số " . $this->contractCode . ' ' . $this->documentLongDateText . " về nội dung " . $certificate->petitioner_name . ' đề nghị ' . $this->companyName . ' thực hiện việc thẩm định giá giá trị tài sản.', 0 , ['size' => '12.5'], 'bullets', array_merge($this->indentFistLine, $this->keepNext));
        $section->addListItem("Căn cứ Báo cáo kết quả thẩm định giá số " . $this->reportCode . ' ' . $this->documentLongDateText . " của " . $this->companyName . ' .', 0 , ['size' => '12.5'], 'bullets', array_merge($this->indentFistLine, $this->keepNext));
        $section->addListItem($this->companyName . " cung cấp Chứng thư thẩm định giá số " . $this->certificateCode .' ' . $this->documentLongDateText . " với các nội dung sau đây:", 0 , ['size' => '12.5'], 'bullets', array_merge($this->indentFistLine, $this->keepNext));
        $section->addTitle("Khách hàng thẩm định giá:", 2);
        $listItemRun1 = $section->addListItemRun(0,'bullets',array_merge($this->indentFistLine, $this->keepNext));
        $listItemRun1->addText("Khách hàng yêu cầu: ", ['size' => '12.5'],array_merge($this->indentFistLine, $this->keepNext));
        $listItemRun1->addText($certificate->petitioner_name, ['size' => '12.5', 'bold' => true],array_merge($this->indentFistLine, $this->keepNext));
        ...
        $section->addListItem("Ngày sinh: " . $certificate->petitioner_birthday,0 , ['size' => '12.5'], 'bullets', array_merge($this->indentFistLine, $this->keepNext));
        $section->addListItem("Địa chỉ: " . $certificate->petitioner_address,0 , ['size' => '12.5'], 'bullets', array_merge($this->indentFistLine, $this->keepNext));
        $section->addListItem("Số CCCD: " . $certificate->petitioner_identity_card,0 , ['size' => '12.5'], 'bullets', array_merge($this->indentFistLine, $this->keepNext));
        $section->addTitle("Thông tin về tài sản thẩm định giá:", 2);
        $section->addListItem("Tài sản thẩm định giá: " . $this->getAssetName($certificate),0 , ['size' => '12.5'], 'bullets', array_merge($this->indentFistLine, $this->keepNext));
        $section->addListItem("Địa chỉ: " . $this->getAssetAddress($certificate),0 , ['size' => '12.5'], 'bullets', array_merge($this->indentFistLine, $this->keepNext));
        $listItemRun2 = $section->addListItemRun(0,'bullets',array_merge($this->indentFistLine, $this->keepNext));
        $listItemRun2->addText("Đặc điểm pháp lý và kinh tế kỹ thuật của tài sản: ", ['size' => '12.5'],array_merge($this->indentFistLine, $this->keepNext));
        $listItemRun2->addText("Chi tiết tại Báo cáo kết quả thẩm định giá kèm theo.", ['size' => '12.5', 'italic' => true],array_merge($this->indentFistLine, $this->keepNext));
