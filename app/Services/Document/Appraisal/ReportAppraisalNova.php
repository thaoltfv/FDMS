...
class ReportAppraisalNova extends ReportAppraisal
{
    ...
    protected function step1Sub2($section, $certificate)
    {
        ...
        // }
        $section->addListItem('Họ và tên Thẩm định viên về giá: ' . ((isset($certificate->appraiser) && isset($certificate->appraiser->name)) ? $certificate->appraiser->name : '') . '_ số thẻ TĐV về giá ' . $appraiserNumber, 0, null, 'bullets');
        // $section->addListItem('Người lập báo cáo: ' . (isset($certificate->createdBy->name) ? $certificate->createdBy->name : ''), 0, null, 'bullets');
        $section->addListItem('Trợ lý thẩm định viên về giá: ' . (isset($certificate->appraiserPerform)  && isset($certificate->appraiserPerform->name) ? $certificate->appraiserPerform->name : ''), 0, null, 'bullets');
    ...
    protected function step1Sub4($section, $certificate)
    {
        ...
        $listTmp = $section->addListItemRun(0, 'bullets');
        $listTmp->addText('Cơ sở giá trị của tài sản thẩm định giá: Giá trị thị trường.', ['bold' => true], []);
        $listTmp = $section->addListItemRun(0, 'bullets');
    ...
    protected function step8(Section $section, $certificate)
    {
        ...
        $section->addText('Căn cứ vào đặc điểm pháp lý tài sản thẩm định giá, mục đích sử dụng hiện tại, hiện trạng tài sản và hiện trạng khu vực tài sản thẩm định giá tọa lạc, tổ thẩm định giá nhận định phương án sử dụng hiện tại của tài sản là phương án sử dụng tốt nhất và hiệu quả nhất.');
    ...
    protected function DCN(Section $section)
    {
        ...
        $section->addText('   - Đối với phương pháp so sánh: Tài sản thẩm định gồm quyền sử dụng đất và công trình xây dựng trên đất. Tại thời điểm thẩm định, khu vực thẩm định không có các giao dịch trong đó các tài sản so sánh có quyền sử dụng đất và công trình xây dựng trên đất tương đồng với tài sản thẩm định. Do đó, trong trường hợp này tổ thẩm định giá không áp dụng được phương pháp so sánh để ước tính giá trị của tài sản thẩm định.');
        ...
        $section->addText('   - Đối với phương pháp chi phí thay thế, chi phí tái tạo: Tổ thẩm định xác định giá trị công trình xây dựng của tài sản thẩm định giá dựa trên cơ sở chênh lệch giữa chi phí thay thế để tạo ra một tài sản công trình xây dựng tương tự tài sản thẩm định giá có cùng chức năng, công dụng theo giá thị trường hiện hành và giá trị hao mòn của công trình xây dựng tài sản thẩm định giá. Do đó, Tổ thẩm định nhận thấy đủ điều kiện để áp dụng phương pháp chi phí thay thế để tiến hành ước tính giá trị tài sản cần thẩm định giá là công trình xây dựng trên đất.');
        $section->addText('   Từ các nội dung trên, Tổ thẩm định giá nhận thấy chỉ áp dụng được phương pháp chi phí thay thế làm phương pháp chính để ước tính giá trị tài sản thẩm định. Không đủ điều kiện để áp dụng các phương pháp khác làm phương pháp kiểm tra, đối chiếu.');
    ...
    protected function DTCC(Section $section)
    {
        ...
        $section->addText('   - Đối với phương pháp chi phí thay thế, chi phí tái tạo: Tài sản thẩm định giá không có công trình xây dựng trên đất nên không ước tính giá trị công trình xây dựng. Do đó, tổ thẩm định giá nhận thấy chưa đủ điều kiện để áp dụng phương pháp chi phí để tiến hành ước tính giá trị tài sản cần thẩm định giá.');
        ...
        $section->addText('   Từ các nội dung trên, Tổ thẩm định giá nhận thấy chỉ áp dụng được phương pháp so sánh làm phương pháp chính để ước tính giá trị tài sản thẩm định. Không đủ điều kiện để áp dụng các phương pháp khác làm phương pháp kiểm tra, đối chiếu.');
    ...
    protected function DCC(Section $section)
    {
        ...
        $section->addText('   - Đối với phương pháp chi phí thay thế, chi phí tái tạo: Tài sản thẩm định giá là quyền sở hữu căn hộ, có nhiều hạn chế về việc ước tính chi phí thay thế, chi phí tái tạo tài sản. Do đó, tổ thẩm định giá nhận thấy chưa đủ điều kiện để áp dụng phương pháp chi phí để tiến hành ước tính giá trị tài sản cần thẩm định giá.');
        $section->addText('   Từ các nội dung trên, Tổ thẩm định giá nhận thấy chỉ áp dụng được phương pháp so sánh làm phương pháp chính để ước tính giá trị tài sản thẩm định. Không đủ điều kiện để áp dụng các phương pháp khác làm phương pháp kiểm tra, đối chiếu.');
        $section->addText('   “Phương pháp so sánh xác định giá trị của tài sản thẩm định giá dựa trên cơ sở đối chiếu, phân tích và đánh giá các yếu tố so sánh của các tài sản so sánh với tài sản thẩm định giá từ đó điều chỉnh mức giá của các tài sản so sánh làm cơ sở ước tính giá trị của tài sản thẩm định giá”.', ['italic' => true]);
    }
    ...
    protected function step8sub3Appraise(Section $section)
    {
        ...
        $section->addListItem('Đối với phương pháp so sánh: Tài sản thẩm định giá gồm quyền sử dụng đất, công trình xây dựng trên đất. Tại thời điểm thẩm định, khu vực thẩm định không có các giao dịch trong đó các tài sản so sánh có quyền sử dụng đất, công trình xây dựng trên đất tương đồng với tài sản thẩm định. Trong trường hợp này tổ thẩm định giá nhận định không đủ điều kiện áp dụng được phương pháp so sánh để ước tính giá trị của tài sản thẩm định giá là quyền sử dụng đất và công trình xây dựng trên đất. Do đó, tổ thẩm định giá chỉ áp dụng phương pháp so sánh để ước tính giá trị quyền sử dụng đất.', 0, null, 'bullets', $this->indentFistLine);
    ...
    protected function signature(Section $section, $certificate)
    {
        ...
        $cell31->addText("Trợ lý Thẩm Định Viên Về Giá", ['bold' => true], ['align' => 'center', 'keepNext' => true]);
        $cell31 = $table3->addCell(Converter::inchToTwip(4));
    ...
    protected function assetCharacteristicsApartment(Section $section, $realEstate)
    {
        ...
        $assetName = 'Tài sản thẩm định là: ' . $fullName  . htmlspecialchars($address);
        $table->addRow(400, $this->cantSplit);
        $table->addCell(600, ['valign' => 'center', 'vMerge' => 'restart'])->addText('2', null, $this->cellHCentered);
        ...
        $table->addCell($this->rowFourthWidth, ['borderLeftSize' => 'none'])->addText(ucfirst(mb_strtolower(CommonService::mbCaseTitle($apartment->apartmentAssetProperties->furnitureQuality->description))));
        $table->addRow(400, $this->cantSplit);
        $table->addCell(null, ['valign' => 'center', 'vMerge' => 'continue']);
        $table->addCell(null, ['valign' => 'center', 'vMerge' => 'continue']);
