...
class ReportAppendix1 extends Report
{
    ...
    protected function processAssetData($asset)
    {
        ...
        if ($method->slug_value === 'theo-ty-le-gia-dat-co-so-chinh') {
            $this->asset1->muc_dich_chinh = $this->getComparisonType($this->comparisonFactor1, 'muc_dich_chinh')->asset_title;
            $this->asset2->muc_dich_chinh = $this->getComparisonType($this->comparisonFactor2, 'muc_dich_chinh')->asset_title;
            $this->asset3->muc_dich_chinh = $this->getComparisonType($this->comparisonFactor3, 'muc_dich_chinh')->asset_title;
        }
