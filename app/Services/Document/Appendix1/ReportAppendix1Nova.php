...
class ReportAppendix1Nova extends ReportAppendix1
{
    ...
    protected function conclusion1($section)
    {
        ...
        $textRun = $section->addTextRun();
        $textRun->addText('     - Tổ thẩm định giá nhận thấy chất lượng thông tin về các tài sản so sánh là tương đương nhau, đồng thời nhận thấy mức giá chỉ dẫn, tổng giá trị điều chỉnh gộp, tổng giá trị điều chỉnh thuần, tổng số lần điều chỉnh, biên độ điều chỉnh của các tài sản không đáng kể. Do đó tổ thẩm định sử dụng mức giá chỉ dẫn ' . $namePP . ' làm mức giá tham chiếu của tài sản thẩm định giá.');
    }
