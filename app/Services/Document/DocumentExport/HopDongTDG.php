...
class HopDongTDG
{
    ...
    public function generateDocx($company, $certificate, $format, $appraises, $priceEstimatePrint): array
    {
        ...
        $row = $table->addRow();
        $row->addCell(9900)->addText("Hoặc thanh toán 02 lần:", null, $indentleftNumber);

        $row = $table->addRow();
        $row->addCell(9900)->addText("Lần 1: Thanh toán số tiền ", null, $indentleftNumber);

        $row = $table->addRow();
        $row->addCell(9900)->addText("Lần 2: Thanh toán số tiền ", null, $indentleftNumber);
