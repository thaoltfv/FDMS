...
class ScreensDefault
{
    ...
    public const ADMIN_SCREENS = array("DASHBOARD", "USER", "ROLE", "MAP", "PRICE", "CATEGORY", "CUSTOMER", "CERTIFICATE_ASSET", "CERTIFICATE_BRIEF", "PRE_CERTIFICATE", "ACCOUNTING");
    public const ROOT_ADMIN_SCREENS = array("DASHBOARD", "USER", "ROLE", "MAP", "PRICE", "CATEGORY", "PROPERTIES", "CUSTOMER", "CERTIFICATE_ASSET", "CERTIFICATE_BRIEF", "PRE_CERTIFICATE", "ACCOUNTING");
