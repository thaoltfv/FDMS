...
class ScreensDefault
{
    ...
    public const ALL_SCREENS = array("DASHBOARD", "USER", "ROLE", "MAP", "PRICE", "CATEGORY", "CUSTOMER", "CERTIFICATE_ASSET", "CERTIFICATE_BRIEF", "PRE_CERTIFICATE", "PAYMENT");
    ...
    public const PAYMENT_SCREEN = "PAYMENT";
}
