 ...
 * @package App\Models
 */
class CertificateAssetTangibleAsset extends Model
{
    use SoftDeletes;
    protected $table = 'certificate_asset_tangible_assets';
    protected $casts = [
        'id' => 'integer',
    ...
    {
        return $this->hasMany(CertificateAssetConstructionCompany::class, 'tangible_asset_id');
    }

    public function comparisonTangibleFactor(): BelongsTo
    {
        return $this->BelongsTo(CertificateAssetTangibleComparisonFactor::class, 'id', 'tangible_asset_id');
    }
}
