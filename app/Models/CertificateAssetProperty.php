 ...
 * @package App\Models
 */
class CertificateAssetProperty extends Model
{
    use SoftDeletes;
    protected $table = 'certificate_asset_properties';
    protected $casts = [
        'id' => 'integer',
    ...
    {
        return $this->hasMany(CertificateAssetPropertyDetail::class,'appraise_property_id')->orderBy('is_transfer_facility', 'DESC');
    }

    public function propertyTurningTime(): HasMany
    {
        return $this->hasMany(CertificateAssetPropertyTurningTime::class,'appraise_property_id');
    }
